...
function AllListVisitors() {
    ...
    },
    {
      ...
      cellRenderer: (params) => (
        <Grid sx={{ display: 'flex' }}>
          ...
          {/* } */}
          {isUserRoleCompare?.includes('eallvisitors') && (
            <Link to={`/interactor/master/editvisitors/${params.data.id}/allvisitor/?status=${params.data.interactorstatus}`} style={{ textDecoration: 'none', color: '#fff', minWidth: '0px' }}>
          ...
          {isUserRoleCompare?.includes('vallvisitors') && (
            <Link to={`/interactor/master/viewvisitors/${params.data.id}/allvisitor/?status=${params.data.interactorstatus}`} style={{ textDecoration: 'none', color: '#fff', minWidth: '0px' }}>
              <Button sx={userStyle.buttonedit} style={{ minWidth: '0px' }}>
          ...
          {isUserRoleCompare?.includes('vallvisitors') && (
            <Link to={`/interactor/master/followupvisitor/${params.data.id}/allvisitor/?status=${params.data.interactorstatus}`} style={{ textDecoration: 'none', color: '#fff', minWidth: '0px' }}>
              <Button sx={userStyle.buttonedit} style={{ minWidth: '0px' }}>
  ...
  return (
    <Box>
      ...
      <PageHeading title="All Visitors" modulename="Interactors" submodulename="Visitor" mainpagename="All Visitors" subpagename="" subsubpagename="" />
      {/* ****** Table Start ****** */}
      <Box sx={userStyle.selectcontainer}>
        <>
          <Grid item xs={8}>
            <Typography sx={userStyle.SubHeaderText}>Filter Visitors Details</Typography>
          </Grid>
          <br />
      ...
      {isUserRoleCompare?.includes('lallvisitors') && (
        <>
          <Box sx={userStyle.container}>
            <Grid container spacing={2}>
              <Grid item xs={8}>
                <Typography sx={userStyle.SubHeaderText}>All Visitors List</Typography>
              </Grid>
              <Grid item xs={4}>
      ...
      />
      <InfoPopup openInfo={openInfo} handleCloseinfo={handleCloseinfo} heading="All Visitors List Info" addedby={addedby} updateby={updateby} />

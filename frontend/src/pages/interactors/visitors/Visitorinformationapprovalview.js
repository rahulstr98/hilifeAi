...
function VisitorInformationMasterApprovalView() {
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String('View Information Approval View'),
...
cbuildingapartmentname:singleCandidate?.cbuildingapartmentname || "",
    ...
    return (
        <Box>
            <Headtitle title={'Visitor Information Approval View'} />
            {/* ****** Header Content ****** */}
            <Typography sx={userStyle.HeaderText}>Visitor Information Approval View </Typography>
            <>
...
export default VisitorInformationMasterApprovalView;

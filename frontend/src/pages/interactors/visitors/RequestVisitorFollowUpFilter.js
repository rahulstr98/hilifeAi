...
function RequestVisitorFollowupFilter() {
  ...
  const fetchVendor = async () => {
    ...
    try {
      ...
      const filtereddata = res_vendor?.data?.visitors.filter((item, index) => {
        ...
        return itemDate >= new Date(filterUser.fromdate) && itemDate <= new Date(filterUser.todate) && (item.interactorstatus == 'requestfollowupvisitor' || item?.requestvisitorfollowupstatus);
      });
  ...
  return (
    <Box>
      ...
      <PageHeading title="Request Visitors FollowUp Filter" modulename="Interactors" submodulename="Visitor" mainpagename="Request Visitors FollowUp Filter" subpagename="" subsubpagename="" />
      <br />
      {/* ****** Table Start ****** */}
        ...
        <>
          <Box sx={userStyle.container}>
            <Grid container spacing={2}>
              <Grid item xs={8}>
                <Typography sx={userStyle.SubHeaderText}>Request Visitors FollowUp Filter List</Typography>
              </Grid>
            </Grid>
            <Grid container spacing={2} style={userStyle.dataTablestyle}>
              ...
              >
                <Box>
                  {isUserRoleCompare?.includes('excelrequestvisitorfollowup') && (
                    <>
                      <Button
                        onClick={(e) => {
                  ...
                  {isUserRoleCompare?.includes('printrequestvisitorfollowup') && (
                    <>
                  ...
                  {isUserRoleCompare?.includes('imagerequestvisitorfollowup') && (
                    <>

...
function Roundmaster() {
  ...
  let exportColumnNames = ["Round Name", "Description"];
  let exportRowValues = ["nameround", "description"];
  ...
  const [roundmaster, setRoundmaster] = useState({ nameround: "", description: "" });
  const [submitLoader, setSubmitLoader] = useState(false);
  const [roundmasterEdit, setRoundmasterEdit] = useState({ nameround: "", description: "" });
  ...
  const sendRequest = async () => {
    ...
    try {
      ...
      await fetchRoundmaster();
      setRoundmaster({ ...roundmaster, nameround: "", description: "" });
  ...
  const handleClear = (e) => {
    e.preventDefault();
    setRoundmaster({ nameround: "", description: "" });

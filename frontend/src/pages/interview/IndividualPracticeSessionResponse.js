...
function IndividualPracticeSessionResponse() {
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "IndividualPracticeSessionResponse.png");
                })
                .catch((error) => {
            ...
            const pipeline = [
                {
                    $match: {
                        ...
                        employeedbid: { $eq: isUserRoleAccess?._id },
                    }
                }, {
                    $addFields: {
    ...
    return (
        <Box>
            <NotificationContainer />
            <Headtitle title={"INDIVIDUAL PRACTICE SESSION RESPONSE"} />
            {/* ****** Header Content ****** */}
            <PageHeading
                title="Individual Practice Session Response"
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12}>
                                        <Typography sx={userStyle.SubHeaderText}>
                                            List Individual Practice Session Response
                                        </Typography>
                                    </Grid>
            ...
            <ExportData
                ...
                itemsTwo={employees ?? []}
                filename={"IndividualPracticeSessionResponse"}
                ...
                <Box sx={{ padding: "20px 50px" }}>
                    <>
                        <Typography sx={userStyle.HeaderText}>
                            {" "}
                            View {isUserRoleAccess?.companyname} Practice Session Response
                        </Typography>
                        <br />
                        <Grid container spacing={2}>
...
export default IndividualPracticeSessionResponse;
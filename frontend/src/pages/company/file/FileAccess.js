...
function FileAccess() {
  ...
  const handleSubmit = (e) => {
    ...
    const isFolderNameMatch = fileAccessArray?.some(
      (item) =>
    ...
    if (fileAccess.foldername === "") {
      setPopupContentMalert("Please Enter Folder Name");
      ...
      setPopupSeverityMalert("info");
      handleClickOpenPopupMalert();
    } else if (isFolderNameMatch) {
      setPopupContentMalert("Folder Name already exists!");
      setPopupSeverityMalert("info");
      handleClickOpenPopupMalert();
    } else if (isNameMatch) {
  ...
  //File Creation updateby edit page...
  ...
  const editSubmit = (e) => {
    ...
    fetchFileAccessAll();
    const isFolderNameMatch = allFileAccessEdit?.some(
      (item) =>
          ...
          {isUserRoleCompare?.includes("lfilecreation") && (
            <Box sx={userStyle.container}>
              ...
              {isUserRoleCompare?.includes("bdfilecreation") && (
                <Button sx={buttonStyles.buttonbulkdelete} color="error" onClick={handleClickOpenalert}>
                  Bulk Delete
                </Button>)}
              <br />
              <br />

...
function AttendanceWithProdOverallReviewListIndividual() {
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("Attendance With Production Individual Review"),
    ...
    const handleprint = useReactToPrint({
        ...
        documentTitle: 'Attendance With Production Individual Review',
        pageStyle: 'print',
    });
    ...
    const handleCaptureImage = () => {
        if (gridRef.current) {
            html2canvas(gridRef.current).then((canvas) => {
                canvas.toBlob((blob) => {
                    saveAs(blob, 'Attendance With Production Individual Review List.png');
                });
            });
        }
    };
    ...
    return (
        <Box>
            <Headtitle title={'ATTENDANCE WITH PRODUCTION INDIVIDUAL REVIEW'} />
            {/* ****** Header Content ****** */}
            <PageHeading
                ...
                subpagename="Attendance With Production Individual Review"
                subsubpagename=""
            />

            {isUserRoleCompare?.includes('lattendancewithproductionindividualreview') && (
                <>
                                ...
                                <>
                                    <Grid container spacing={2} style={userStyle.dataTablestyle}>
                                        ...
                                        <Grid item md={8} xs={12} sm={12} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', }}>
                                            <Box>
                                                {isUserRoleCompare?.includes('excelattendancewithproductionindividualreview') && (
                                                    <>
                                                        <Button
                                                            onClick={(e) => {
                                                ...
                                                {isUserRoleCompare?.includes('csvattendancewithproductionindividualreview') && (
                                                    <>
                                                        <Button
                                                            onClick={(e) => {
                                                                setIsFilterOpen(true);
                                                ...
                                                {isUserRoleCompare?.includes('printattendancewithproductionindividualreview') && (
                                                    <>
                                                ...
                                                {isUserRoleCompare?.includes('pdfattendancewithproductionindividualreview') && (
                                                    <>
                                                ...
                                                {isUserRoleCompare?.includes('imageattendancewithproductionindividualreview') && (
            ...
            <ExportData
                ...
                itemsTwo={items ?? []}
                filename={'Attendance With Production Individual Review'}

...
import { Box, Typography, Dialog, TextareaAutosize, FormControlLabel, Checkbox, Divider, DialogContent, DialogActions, FormControl, Grid, Button } from "@mui/material";
...
function TaskTabs() {
  ...
  const rowData = async () => {
    try {
      ...
      setUItasksuser(res_project?.data?.staskAssignBoardList.uidesign);

      const dataTime = res_project?.data?.staskAssignBoardList?.uidesign?.map((item, index) => ({
        ...item,
      ...
      res_project?.data?.staskAssignBoardList?.uidesign.forEach(entry => {
  ...
  // const data = [
  //   { name: "name1", time: "5 Minutes" },
  //   { name: "name2", time: "5 Minutes" },
  //   { name: "name3", time: "10 Minutes" },
  //   { name: "name4", time: "1 Hours" },
  // ];
          ...
          <Box>
            ...
            <Grid container spacing={2}>
              <Grid item md={3} xs={3} sm={3}>
                ...
                <h3>{uiTasks.project}</h3>
              </Grid>
              <Grid item md={3} xs={3} sm={3}>
                <Typography>Subproject : </Typography>
                <h3>{uiTasks.subproject}</h3>
              </Grid>
              <Grid item md={3} xs={3} sm={3}>
                <Typography>Module : </Typography>
                <h3>{uiTasks.module}</h3>
              </Grid>
              <Grid item md={3} xs={3} sm={3}>
                <Typography>SubModule : </Typography>
                <h3>{uiTasks.submodule}</h3>
              </Grid>
              {uiTasks.mainpage && (
                <Grid item md={3} xs={3} sm={3}>
                  <Typography>Mainpage : </Typography>
                  <h3>{uiTasks.mainpage}</h3>
                </Grid>
              )}
              {uiTasks.subpage && (
                <Grid item md={3} xs={3} sm={3}>
                  <Typography>Subpage : </Typography>
                  <h3>{uiTasks.subpage}</h3>
                </Grid>
              )}
              {uiTasks.name && (
                <Grid item md={3} xs={3} sm={3}>
                ...
                return (
                  <div key={index}>
                    <Grid container sx={{ padding: "0px 10px", display: "flex", alignItems: "center" }}>
                      <Grid md={1.5} sm={6} xs={12} sx={{ whiteSpace: "pre-line", wordBreak: "break-all" }}>
                        <FormControl>
                          <FormControlLabel
                      ...
                      <Grid md={2.5} sm={6} xs={12} sx={{ whiteSpace: "pre-line", wordBreak: "break-all" }}>

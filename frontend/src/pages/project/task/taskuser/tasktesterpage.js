...
function TaskTabs() {
  ...
  const rowData = async () => {
    try {
      ...
      let testuidata = res_project?.data?.staskAssignBoardListnewTestui.map((item) => ({ ...item, ...objtestUI }));
      let testdata = res_project?.data?.staskAssignBoardListnewTest.map((item) => ({ ...item, ...objtest }));
  ...
  const getRowDataId = (idval, title) => {
  ...
  const sendCompleRequest = async (taskid) => {
    ...
    try {
      ...
      // let id2 = findidArray[1];
      // let id3 = findidArray[2];
          ...
          <Box>
            <Grid container spacing={2}>
              ...
              <Grid item md={5} xs={6} sm={5} style={{ display: "flex", justifyContent: "center", gap: "10px" }}>
                ...
                <Typography style={{ marginTop: "10px", fontFamily: "auto", fontWeight: "900" }}>{testTasks?.assignedby}</Typography>
              </Grid>
              ...
              <Grid item md={2} xs={12} sm={12} sx={{ display: "flex", justifyContent: "end" }}>
                <Button
                  ...
                  onClick={() => {
                    sendCompleRequest(testTasks.taskid);
                  }}
                >
                  Complete
                </Button>
                      ...
                      <Grid container sx={{ padding: "0px 10px", display: "flex", alignItems: "center" }}>
                            ...
                            <FormControlLabel
                              ...
                              control={
                                <Checkbox
                                  ...
                                  onClick={(e) => {
                                    handleClickOpenerrFiles(data._id, data.state, data.title);
                                  }}
                                  name=""
                        ...
                        <Grid md={0.5} sm={12} xs={12}>
                          <FolderIcon
                            ...
                            onClick={(e) => {
                              getRowDataId(data._id, data.title);
                            }}
                          />
                        </Grid>
                          ...
                          <Grid md={1} sm={12} xs={12} style={{ display: "flex", alignItems: "flex-start", justifyContent: "center" }}>
                            {data.state === "running" ? (
                              <Button
                                ...
                                onClick={() => {
                                  handleUpdateTodoEditpaused(data._id, data.title);
                                }}
                              >
                                Pause
                              </Button>
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  handleUpdateTodoEditrunning(data._id, data.title, data.priority);
                                }}
                              >
                                Start
                              </Button>

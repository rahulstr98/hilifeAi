  ...
  useEffect(() => {
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("Employee Document Status"),
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "EmployeeDocumentStatus.png");
                })
                .catch((error) => {
    ...
    // Excel
    const fileName = "EmployeeDocumentStatus";
    let excelno = 1;
    ...
    const handleprint = useReactToPrint({
        ...
        documentTitle: "EmployeeDocumentStatus",
        pageStyle: "print",
    });
    ...
    return (
        <>
            <Headtitle title={"EMPLOYEE DOCUMENT STATUS"} />
            <PageHeading
                title="Employee Document Preparation"
                modulename="Human Resources"
                submodulename="HR Documents"
                mainpagename="Employee Document Status"
                subpagename=""
                subsubpagename=""
            />
            {/* ****** Table Start ****** */}
            {isUserRoleCompare?.includes("lemployeeloginstatus") && (
                <>
                    <Box sx={userStyle.container}>
                        {/* ******************************************************EXPORT Buttons****************************************************** */}
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>Employee Document Status List </Typography>
                        </Grid>
...
export default EmployeeDocumentStatus;
      ...
      {isUserRoleCompare?.includes('lcompanydocumentskeywords') && (
        <Box sx={userStyle.selectcontainer}>
          ...
          <Grid container spacing={2} style={userStyle.dataTablestyle}>
            ...
            >
              {/* <Box>
                {isUserRoleCompare?.includes("excelcompanydocumentprintedstatuslist") && (
                ...
                {isUserRoleCompare?.includes("csvcompanydocumentprintedstatuslist") && (
                ...
                {isUserRoleCompare?.includes("printcompanydocumentprintedstatuslist") && (
                  <>
                ...
                {isUserRoleCompare?.includes("pdfcompanydocumentprintedstatuslist") && (
                  <>
                ...
                {isUserRoleCompare?.includes("imagecompanydocumentprintedstatuslist") && (

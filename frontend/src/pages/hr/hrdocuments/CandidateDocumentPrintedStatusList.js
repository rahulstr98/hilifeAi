...
function CandidateDocumentsPrintedStatusList() {
  ...
  const TemplateDropdowns = async () => {
    ...
    try {
      let res = await axios.post(
        SERVICE.CANDIDATE_TEMPLATE_CREATION_ASSIGN_BRANCH,
        {
  ...
  const handleFilter = () => {
    if (
      ...
      selectedOptionsTemplate?.length === 0
    ) {
  ...
  const fetchBrandMaster = async () => {
    ...
    try {
      let res_freq = await axios.post(
        `${SERVICE.ACCESSBRANCH_CANDIDATE_PRINTED_LIST}`,
        queryParams,
        {
          headers: {
            Authorization: `Bearer ${auth.APIToken}`,
  ...
  const downloadPdfTesdtTable = async (e, pagename) => {
    ...
    if (
      ...
      pdfElement.innerHTML =
        response.data.scandidateDocumentPreparation.document;
    ...
    background-color: #f9f9f9;
      ...
      const addPageNumbersAndHeadersFooters = (
        ...
        for (let i = 1; i <= totalPages; i++) {
          ...
          const footerX = 5;
          const footerY =
            pageHeight * 1 - (footerDisp === "" ? 15 : footerImgHeight - 3);
          doc.addImage(
            footerDisp,
            "JPEG",
            footerX,
...
.__se__t-shadow {
              ...
              reader.onloadend = async () => {
                ...
                let res_module = await axios.post(
                  SERVICE.CANDIDATE_DOCUMENT_PREPARATION_MAIL,
                  {
                    ...
                    pagename: pagename,
                    approval:
                      response?.data?.scandidateDocumentPreparation?.approval,
                  },
                  {
                    headers: {
                      Authorization: `Bearer ${auth.APIToken}`,
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading
        title="Candidate Document Printed Status List"
        modulename="Human Resources"
        submodulename="HR Documents"
        mainpagename="Candidate Documents"
        subpagename="Candidate Document Printed Status List"
        subsubpagename=""
      />
      ...
      {isUserRoleCompare?.includes("lcandidatedocumentprintedlist") && (
        <>
          <Box sx={userStyle.selectcontainer}>
            ...
            <Grid item xs={8}>
              <Typography sx={userStyle.importheadtext}>
                Candidate Document Printed Status Filter{" "}
              </Typography>
            </Grid>
            <br />
          ...
          <Box sx={userStyle.selectcontainer}>
            <Grid item xs={8}>
              <Typography sx={userStyle.importheadtext}>
                Candidate Document Printed Status List
              </Typography>
            </Grid>
              ...
              >
                <Box>
                  {isUserRoleCompare?.includes(
                    "excelcandidatedocumentprintedlist"
                  ) && (
                    <>
                      <Button
                        onClick={(e) => {
                  ...
                  {isUserRoleCompare?.includes(
                    "csvcandidatedocumentprintedlist"
                  ) && (
                    <>
                      <Button
                        onClick={(e) => {
                  ...
                  {isUserRoleCompare?.includes(
                    "printcandidatedocumentprintedlist"
                  ) && (
                    <>
                  ...
                  {isUserRoleCompare?.includes(
                    "pdfcandidatedocumentprintedlist"
                  ) && (
                    <>
                      <Button
                        sx={userStyle.buttongrp}
                  ...
                  {isUserRoleCompare?.includes(
                    "imagecandidatedocumentprintedlist"
                  ) && (
                    <Button
                      sx={userStyle.buttongrp}
      ...
      <InfoPopup
        ...
        heading="Candidate Printed Documents Info"
        addedby={addedby}
        updateby={updateby}
      />
      ...
      <ExportData
        ...
        itemsTwo={items ?? []}
        filename={"Candidate Printed Documents List"}

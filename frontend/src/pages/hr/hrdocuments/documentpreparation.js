  ...
  const answerDefine = async (person, index) => {
    ...
    ${!employee?.ppincode ? '' : '- ' + employee?.ppincode}`;
        ...
        let findMethod = texted
          ...
          .replaceAll('$NOTICEPERIOD_DAYS$', departmentDesigDateBased ? departmentDesigDateBased?.noticeperiodDays : '')
          .replaceAll('$PROBATION_PERIOD$', departmentDesigDateBased ? departmentDesigDateBased?.probationPeriod : '')
          .replaceAll('$USER_NOTICE_PERIOD_APPLIED$', departmentDesigDateBased ? departmentDesigDateBased?.userNoticeperiodApplied : '')
          .replaceAll('$USER_NOTICE_PERIOD_REQUEST$', departmentDesigDateBased ? departmentDesigDateBased?.userNoticeperiodRequest : '')
          .replaceAll('$USER_NOTICE_PERIOD_ENDDATE$', departmentDesigDateBased ? departmentDesigDateBased?.userNoticeperiodEnd : '')
          .replaceAll('$USER_NOTICE_PERIOD_STATUS$', departmentDesigDateBased ? departmentDesigDateBased?.noticePeriodStatus : '')

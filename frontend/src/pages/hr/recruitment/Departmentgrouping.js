...
function Departmentgrouping() {
  ...
  let exportColumnNames = ["Department Name", "Departments"];
  let exportRowValues = ["departmentname", "departments"];
  ...
  const getapi = async () => {
    let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
      ...
      pagename: String("Department Grouping"),
  ...
  const handleSubmit = async (e) => {
    ...
    if (departmentGrouping.departmentname === "") {
      setPopupContentMalert("Please Enter Department Name!");
      setPopupSeverityMalert("info");
      handleClickOpenPopupMalert();
    } else if (departmentsgroup.length <= 0) {
      setPopupContentMalert("Please Select Departments!");
      setPopupSeverityMalert("info");
      handleClickOpenPopupMalert();
    } else if (isNameMatch) {
      setPopupContentMalert("DepartmentGrouping already Exist!");
      setPopupSeverityMalert("info");
      handleClickOpenPopupMalert();
    } else {
      sendRequest();
  ...
  const editSubmit = async (e) => {
    ...
    if (connectivityEdit.departmentname === "") {
      setPopupContentMalert("Please Enter Depatment Name!");
      setPopupSeverityMalert("info");
      handleClickOpenPopupMalert();
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Grid sx={{ display: "flex" }}>
          {isUserRoleCompare?.includes("edepartmentgrouping") && (
            <Button
          ...
          {isUserRoleCompare?.includes("ddepartmentgrouping") && (
            <Button
          ...
          {isUserRoleCompare?.includes("vdepartmentgrouping") && (
            <Button
              sx={userStyle.buttonedit}
              onClick={() => {
          ...
          {isUserRoleCompare?.includes("idepartmentgrouping") && (
            <Button
              sx={userStyle.buttonedit}
              onClick={() => {
  ...
  return (
    <Box>
      ...
      />
      {/* ****** Header Content ****** */}
      {isUserRoleCompare?.includes("adepartmentgrouping") && (
        <>
      ...
      {!loader ? (
        ...
        <>
          {isUserRoleCompare?.includes("ldepartmentgrouping") && (
            <Box sx={userStyle.container}>
              {/* ******************************************************EXPORT Buttons****************************************************** */}
              <Grid item xs={8}>
                <Typography sx={userStyle.importheadtext}>
              ...
              <Grid container spacing={2} style={userStyle.dataTablestyle}>
                ...
                >
                  <Box>
                    {isUserRoleCompare?.includes("exceldepartmentgrouping") && (
                      <>
                        <Button
                          onClick={(e) => {
                    ...
                    {isUserRoleCompare?.includes("csvdepartmentgrouping") && (
                      <>
                        <Button
                          onClick={(e) => {
                            setIsFilterOpen(true);
                    ...
                    {isUserRoleCompare?.includes("printdepartmentgrouping") && (
                      <>
                    ...
                    {isUserRoleCompare?.includes("pdfdepartmentgrouping") && (
                      <>
                        <Button
                          sx={userStyle.buttongrp}
                          onClick={() => {
                    ...
                    {isUserRoleCompare?.includes("imagedepartmentgrouping") && (
                      <Button
                        sx={userStyle.buttongrp}
              ...
              &ensp;
              {isUserRoleCompare?.includes("bddepartmentgrouping") && (
                <Button
                  variant="contained"
      ...
      <InfoPopup
        ...
        heading="Department Grouping Info"
        addedby={addedby}
        updateby={updateby}
      />

...
function MyShiftRoasterList({ allUsersShiftFinal, allMyFinalAdj, daysArray, allUserDates, overAllDepartment }) {

    const gridRefTableMyFinalAdjLast = useRef(null);
    const gridRefImageMyFinalAdjLast = useRef(null);

    const { isUserRoleCompare } = useContext(UserRoleAccessContext);

    // State to track advanced filter
    const [advancedFilterMyFinalAdjLast, setAdvancedFilterMyFinalAdjLast] = useState(null);
    const [gridApi, setGridApi] = useState(null);
    const [columnApi, setColumnApi] = useState(null);
    const [filteredDataItemsMyFinalAdjLast, setFilteredDataItemsMyFinalAdjLast] = useState(allUsersShiftFinal);
    const [filteredRowDataMyFinalAdjLast, setFilteredRowData] = useState([]);

    // Datatable Set Table
    const [pageMyFinalAdjLast, setPageMyFinalAdjLast] = useState(1);
    const [pageSizeMyFinalAdjLast, setPageSizeMyFinalAdjLast] = useState(10);
    const [searchQueryMyFinalAdjLast, setSearchQueryMyFinalAdjLast] = useState("");
    const [totalPagesMyFinalAdjLast, setTotalPagesMyFinalAdjLast] = useState(1);

    const [isFilterOpenMyFinalAdjLast, setIsFilterOpenMyFinalAdjLast] = useState(false);
    const [isPdfFilterOpenMyFinalAdjLast, setIsPdfFilterOpenMyFinalAdjLast] = useState(false);
    // page refersh reload
    const handleCloseFilterModMyFinalAdjLast = () => { setIsFilterOpenMyFinalAdjLast(false); };
    const handleClosePdfFilterModMyFinalAdjLast = () => { setIsPdfFilterOpenMyFinalAdjLast(false); };

    // Manage Columns
    const [searchQueryManageMyFinalAdjLast, setSearchQueryManageMyFinalAdjLast] = useState("");
    const [isManageColumnsOpenMyFinalAdjLast, setManageColumnsOpenMyFinalAdjLast] = useState(false);
    const [anchorElMyFinalAdjLast, setAnchorElMyFinalAdjLast] = useState(null);

    const handleOpenManageColumnsMyFinalAdjLast = (event) => {
        setAnchorElMyFinalAdjLast(event.currentTarget);
        setManageColumnsOpenMyFinalAdjLast(true);
    };
    const handleCloseManageColumnsMyFinalAdjLast = () => {
        setManageColumnsOpenMyFinalAdjLast(false);
        setSearchQueryManageMyFinalAdjLast("");
    };

    const openMyFinalAdjLast = Boolean(anchorElMyFinalAdjLast);
    const idMyFinalAdjLast = openMyFinalAdjLast ? "simple-popover" : undefined;

    // Search bar
    const [anchorElSearchMyFinalAdjLast, setAnchorElSearchMyFinalAdjLast] = React.useState(null);
    const handleClickSearchMyFinalAdjLast = (event) => {
        setAnchorElSearchMyFinalAdjLast(event.currentTarget);
    };
    const handleCloseSearchMyFinalAdjLast = () => {
        setAnchorElSearchMyFinalAdjLast(null);
        setSearchQueryMyFinalAdjLast("");
    };

    const openSearchMyFinalAdjLast = Boolean(anchorElSearchMyFinalAdjLast);
    const idSearchMyFinalAdjLast = openSearchMyFinalAdjLast ? 'simple-popover' : undefined;
    ...
    const [columnVisibilityMyFinalAdjLast, setColumnVisibilityMyFinalAdjLast] = useState({});
    const [itemsMyFinalAdjLast, setItemsMyFinalAdjLast] = useState([]);
    const addSerialNumberMyFinalAdjLast = () => {
        const itemsWithSerialNumberFinal = allUsersShiftFinal?.flatMap((item, index) => {
            ...
            const days = daysArray.map((column, index) => {
                let filteredRowDataFinalAdj = allUserDates.filter((val) => val.empcode == item.empcode);
        ...
        let resultFinal = itemsWithSerialNumberFinal?.map((item, index) => ({
            ...item,
        ...
        setItemsMyFinalAdjLast(resultFinal);
        setFilteredDataItemsMyFinalAdjLast(resultFinal);
        setColumnVisibilityMyFinalAdjLast({
            serialNumber: true,
            checkbox: true,
            empcode: true,
            username: true,
    ...
    useEffect(() => {
        addSerialNumberMyFinalAdjLast();
    }, [allUsersShiftFinal])

    // Show All Columns & Manage Columns
    const initialColumnVisibilityMyFinalAdjLast = {
        serialNumber: true,
        checkbox: true,
        empcode: true,
        username: true,
    ...
    const onGridReadyMyFinalAdjLast = useCallback((params) => {
        setGridApi(params.api);
        setColumnApi(params.columnApi);
    }, []);

    // Function to handle filter changes
    const onFilterChangedMyFinalAdjLast = () => {
        if (gridApi) {
            ...
            if (Object.keys(filterModel).length === 0) {
                ...
                const filteredDataMyFinalAdjLast = [];
                gridApi.forEachNodeAfterFilterAndSort((node) => {
                    filteredDataMyFinalAdjLast.push(node.data); // Collect filtered row data
                });
                setFilteredRowData(filteredDataMyFinalAdjLast);
            }
        }
    };

    const onPaginationChangedMyFinalAdjLast = useCallback(() => {
        if (gridRefTableMyFinalAdjLast.current) {
            const gridApi = gridRefTableMyFinalAdjLast.current.api;
            const currentPage = gridApi.paginationGetCurrentPage() + 1;
            const totalPagesMyFinalAdjLast = gridApi.paginationGetTotalPages();
            setPageMyFinalAdjLast(currentPage);
            setTotalPagesMyFinalAdjLast(totalPagesMyFinalAdjLast);
        }
    }, []);

    const columnDataTableMyFinalAdjLast = [
        { field: "serialNumber", headerName: "SNo", flex: 0, width: 80, hide: !columnVisibilityMyFinalAdjLast.serialNumber, headerClassName: "bold-header", pinned: 'left', lockPinned: true, },
        { field: "empcode", headerName: "Emp Code", flex: 0, width: 150, hide: !columnVisibilityMyFinalAdjLast.empcode, headerClassName: "bold-header", pinned: 'left', lockPinned: true, },
        { field: "username", headerName: "Name", flex: 0, width: 250, hide: !columnVisibilityMyFinalAdjLast.username, headerClassName: "bold-header", pinned: 'left', lockPinned: true, },
        { field: "department", headerName: "Department", flex: 0, width: 200, hide: !columnVisibilityMyFinalAdjLast.department, headerClassName: "bold-header", },
        { field: "branch", headerName: "Branch", flex: 0, width: 150, hide: !columnVisibilityMyFinalAdjLast.branch, headerClassName: "bold-header", },
        { field: "unit", headerName: "Unit", flex: 0, width: 150, hide: !columnVisibilityMyFinalAdjLast.unit, headerClassName: "bold-header", },
        ...daysArray.map((column, index) => {
            ...
            return {
                ...
                hide: !columnVisibilityMyFinalAdjLast[`${column.formattedDate} ${column.dayName} Day${column.dayCount}`],
                flex: 0,
                width: 150,
                filter: false,
                sortable: false,
    ...
    // Datatable
    const handleSearchChangeMyFinalAdjLast = (e) => {
        const value = e.target.value;
        setSearchQueryMyFinalAdjLast(value);
        applyNormalFilterMyFinalAdjLast(value);
        setFilteredRowData([]);
    };

    const applyNormalFilterMyFinalAdjLast = (searchValue) => {

        // Split the search query into individual terms
        const searchTerms = searchValue.toLowerCase().split(" ");

        // Modify the filtering logic to check each term
        const filtered = allUsersShiftFinal?.filter((item) => {
            return searchTerms.every((term) =>
                Object.values(item).join(" ").toLowerCase().includes(term)
            );
        });
        setFilteredDataItemsMyFinalAdjLast(filtered);
        setPageMyFinalAdjLast(1);
    };

    const applyAdvancedFilterMyFinalAdjLast = (filters, logicOperator) => {
        ...
        setFilteredDataItemsMyFinalAdjLast(filtered); // Update filtered data
        setAdvancedFilterMyFinalAdjLast(filters);
        // handleCloseSearchMyFinalAdjLast(); // Close the popover after search
    };

    // Undo filter funtion
    const handleResetSearchMyFinalAdjLast = () => {
        setAdvancedFilterMyFinalAdjLast(null);
        setSearchQueryMyFinalAdjLast("");
        setFilteredDataItemsMyFinalAdjLast(allUsersShiftFinal);
    };

    // Show filtered combination in the search bar
    const getSearchDisplayMyFinalAdjLast = () => {
        if (advancedFilterMyFinalAdjLast && advancedFilterMyFinalAdjLast.length > 0) {
            return advancedFilterMyFinalAdjLast.map((filter, index) => {
                let showname = columnDataTableMyFinalAdjLast.find(col => col.field === filter.column)?.headerName;
                return `${showname} ${filter.condition} "${filter.value}"`;
            }).join(' ' + (advancedFilterMyFinalAdjLast.length > 1 ? advancedFilterMyFinalAdjLast[1].condition : '') + ' ');
        }
        return searchQueryMyFinalAdjLast;
    };

    const handlePageChangeMyFinalAdjLast = (newPage) => {
        if (newPage >= 1 && newPage <= totalPagesMyFinalAdjLast) {
            setPageMyFinalAdjLast(newPage);
            gridRefTableMyFinalAdjLast.current.api.paginationGoToPage(newPage - 1);
        }
    };

    const handlePageSizeChangeMyFinalAdjLast = (e) => {
        const newSize = Number(e.target.value);
        setPageSizeMyFinalAdjLast(newSize);
        if (gridApi) {
    ...
    const handleShowAllColumnsMyFinalAdjLast = () => {
        const updatedVisibility = { ...columnVisibilityMyFinalAdjLast };
        for (const columnKey in updatedVisibility) {
            updatedVisibility[columnKey] = true;
        }
        setColumnVisibilityMyFinalAdjLast(updatedVisibility);
    };

    useEffect(() => {
        // Retrieve column visibility from localStorage (if available)
        const savedVisibility = localStorage.getItem("columnVisibilityMyFinalAdjLast");
        if (savedVisibility) {
            setColumnVisibilityMyFinalAdjLast(JSON.parse(savedVisibility));
        }
    }, []);

    useEffect(() => {
        // Save column visibility to localStorage whenever it changes
        localStorage.setItem("columnVisibilityMyFinalAdjLast", JSON.stringify(columnVisibilityMyFinalAdjLast));
    }, [columnVisibilityMyFinalAdjLast]);

    // // Function to filter columns based on search query
    const filteredColumnsMyFinalAdjLast = columnDataTableMyFinalAdjLast.filter((column) => column.headerName.toLowerCase().includes(searchQueryManageMyFinalAdjLast.toLowerCase()));
    ...
    const toggleColumnVisibilityMyFinalAdjLast = (field) => {
        if (!gridApi) return;

        setColumnVisibilityMyFinalAdjLast((prevVisibility) => {
    ...
    const handleColumnMovedMyFinalAdjLast = useCallback(debounce((event) => {
    ...
    const handleColumnVisibleMyFinalAdjLast = useCallback((event) => {
    ...
    const getVisiblePageNumbersMyFinalAdjLast = () => {
        const pageNumbers = [];
        const maxVisiblePages = 3;

        const startPage = Math.max(1, pageMyFinalAdjLast - 1);
        const endPage = Math.min(totalPagesMyFinalAdjLast, startPage + maxVisiblePages - 1);

        // Loop through and add visible pageMyFinalAdjLast numbers
        for (let i = startPage; i <= endPage; i++) {
            pageNumbers.push(i);
        }

        // If there are more pages after the last visible pageMyFinalAdjLast, show ellipsis
        if (endPage < totalPagesMyFinalAdjLast) {
            pageNumbers.push("...");
        }
    ...
    const filteredDataMyFinalAdjLast = filteredDataItemsMyFinalAdjLast?.slice((pageMyFinalAdjLast - 1) * pageSizeMyFinalAdjLast, pageMyFinalAdjLast * pageSizeMyFinalAdjLast);
    const totalPagesMyFinalAdjLastOuter = Math.ceil(filteredDataItemsMyFinalAdjLast?.length / pageSizeMyFinalAdjLast);
    const visiblePages = Math.min(totalPagesMyFinalAdjLastOuter, 3);
    const firstVisiblePage = Math.max(1, pageMyFinalAdjLast - 1);
    const lastVisiblePage = Math.min(firstVisiblePage + visiblePages - 1, totalPagesMyFinalAdjLastOuter);
    const pageNumbers = [];
    const indexOfLastItem = pageMyFinalAdjLast * pageSizeMyFinalAdjLast;
    const indexOfFirstItem = indexOfLastItem - pageSizeMyFinalAdjLast;
    for (let i = firstVisiblePage; i <= lastVisiblePage; i++) { pageNumbers.push(i); }

    // Excel
    const fileNameMyFinalAdjLast = "Shift Final List";
    const [fileFormatMyFinalAdjLast, setFormatMyFinalAdjLast] = useState('')
    const fileTypeMyFinalAdjLast = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=UTF-8';
    const fileExtensionMyFinalAdjLast = fileFormatMyFinalAdjLast === "xl" ? '.xlsx' : '.csv';
    const exportToCSVMyFinalAdjLast = (csvData, fileNameMyFinalAdjLast) => {
        const ws = XLSX.utils.json_to_sheet(csvData);
        const wb = { Sheets: { 'data': ws }, SheetNames: ['data'] };
        const excelBuffer = XLSX.write(wb, { bookType: 'xlsx', type: 'array' });
        const data = new Blob([excelBuffer], { type: fileTypeMyFinalAdjLast });
        FileSaver.saveAs(data, fileNameMyFinalAdjLast + fileExtensionMyFinalAdjLast);
    }

    const handleExportXLMyFinalAdjLast = (isfilter) => {
        ...
        let data = [];
        let resultdataMyFinalAdjLast = (filteredRowDataMyFinalAdjLast.length > 0 ? filteredRowDataMyFinalAdjLast : filteredDataMyFinalAdjLast)

        if (isfilter === "filtered") {
            data = resultdataMyFinalAdjLast.map((row, index) => {
                return [
                    row.serialNumber,
                    row.empcode,
                    row.username,
            ...
            data = itemsMyFinalAdjLast.map((row, index) => {
                return [
                    row.serialNumber,
                    row.empcode,
                    row.companyname,
        ...
        // Export to CSV
        exportToCSVMyFinalAdjLast(formattedData, fileNameMyFinalAdjLast);
        setIsFilterOpenMyFinalAdjLast(false);
    };

    // print...
    const componentRefSetTable = useRef();
    const handleprintMyFinalAdjLast = useReactToPrint({
        content: () => componentRefSetTable.current,
        documentTitle: "Shift Final List",
        pageStyle: "print",
    });

    const downloadPdfMyFinalAdjLast = (isfilter) => {
    ...
    // image
    const handleCaptureImageMyFinalAdjLast = () => {
        if (gridRefImageMyFinalAdjLast.current) {
            domtoimage.toBlob(gridRefImageMyFinalAdjLast.current)
                .then((blob) => {
    ...
    return (
        <Box>
                            ...
                            <Grid item md={2} xs={12} sm={12}>
                                <Box>
                                    ...
                                    <Select size="small"
                                        ...
                                        onChange={handlePageSizeChangeMyFinalAdjLast}
                                        sx={{ width: "77px" }}
                                    >
                            ...
                            <Grid item md={8} xs={12} sm={12} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                                <Box>
                                    {isUserRoleCompare?.includes("excelmyshiftroaster") && (
                                        <>
                                            <Button onClick={(e) => {
                                                setIsFilterOpenMyFinalAdjLast(true)
                                                setFormatMyFinalAdjLast("xl")
                                    ...
                                    {isUserRoleCompare?.includes("csvmyshiftroaster") && (
                                        <>
                                            <Button onClick={(e) => {
                                                setIsFilterOpenMyFinalAdjLast(true)
                                                setFormatMyFinalAdjLast("csv")
                                            }} sx={userStyle.buttongrp}><FaFileCsv />&ensp;Export to CSV&ensp;</Button>
                                        </>
                                    )}
                                    {isUserRoleCompare?.includes("printmyshiftroaster") && (
                                        <>
                                            <Button sx={userStyle.buttongrp} onClick={handleprintMyFinalAdjLast}>
                                                &ensp;
                                                <FaPrint />
                                                &ensp;Print&ensp;
                                            </Button>
                                    ...
                                    {isUserRoleCompare?.includes("pdfmyshiftroaster") && (
                                        <>
                                            <Button sx={userStyle.buttongrp}
                                                onClick={() => {
                                                    setIsPdfFilterOpenMyFinalAdjLast(true)
                                                }}
                                    ...
                                    {isUserRoleCompare?.includes("imagemyshiftroaster") && (
                                        <>
                                            <Button sx={userStyle.buttongrp} onClick={handleCaptureImageMyFinalAdjLast}>
                                    ...
                                    <OutlinedInput size="small"
                                        ...
                                        endAdornment={
                                            <InputAdornment position="end">
                                                {advancedFilterMyFinalAdjLast && (
                                                    <IconButton onClick={handleResetSearchMyFinalAdjLast}>
                                                        <MdClose />
                                                    </IconButton>
                                                )}
                                                <Tooltip title="Show search options">
                                                    <span>
                                                        <IoMdOptions style={{ cursor: 'pointer', }} onClick={handleClickSearchMyFinalAdjLast} />
                                                    </span>
                                                </Tooltip>
                                            </InputAdornment>}
                                        ...
                                        type="text"
                                        value={getSearchDisplayMyFinalAdjLast()}
                                        onChange={handleSearchChangeMyFinalAdjLast}
                                        placeholder="Type to search..."
                                        disabled={!!advancedFilterMyFinalAdjLast}
                                    />
                                </FormControl>
                            </Grid>
                        </Grid>  <br />
                        <Button sx={userStyle.buttongrp} onClick={handleShowAllColumnsMyFinalAdjLast}>  Show All Columns </Button>&ensp;
                        <Button sx={userStyle.buttongrp} onClick={handleOpenManageColumnsMyFinalAdjLast}> Manage Columns  </Button><br /><br />
                        {allMyFinalAdj ?
                            <>
                            ...
                            <>
                                <Box sx={{ width: "100%", }} className={"ag-theme-quartz"} ref={gridRefImageMyFinalAdjLast} >
                                    <AgGridReact
                                        rowData={filteredDataItemsMyFinalAdjLast}
                                        columnDefs={columnDataTableMyFinalAdjLast.filter((column) => columnVisibilityMyFinalAdjLast[column.field])}
                                        ref={gridRefTableMyFinalAdjLast}
                                        defaultColDef={defaultColDef}
                                        domLayout={"autoHeight"}
                                        getRowStyle={getRowStyle}
                                        getRowHeight={getRowHeight}
                                        pagination={true}
                                        paginationPageSize={pageSizeMyFinalAdjLast}
                                        onPaginationChanged={onPaginationChangedMyFinalAdjLast}
                                        onGridReady={onGridReadyMyFinalAdjLast}
                                        onColumnMoved={handleColumnMovedMyFinalAdjLast}
                                        onColumnVisible={handleColumnVisibleMyFinalAdjLast}
                                        onFilterChanged={onFilterChangedMyFinalAdjLast}
                                    ...
                                    <Box>
                                        Showing{" "}
                                        {
                                            gridApi && gridApi.getFilterModel() && Object.keys(gridApi.getFilterModel()).length === 0 ? (
                                                (filteredDataItemsMyFinalAdjLast.length > 0 ? (pageMyFinalAdjLast - 1) * pageSizeUserShift + 1 : 0)
                                            ) : (
                                                filteredRowDataMyFinalAdjLast.length > 0 ? (pageMyFinalAdjLast - 1) * pageSizeUserShift + 1 : 0
                                            )
                                        }{" "}to{" "}
                                        {
                                            gridApi && gridApi.getFilterModel() && Object.keys(gridApi.getFilterModel()).length === 0 ? (
                                                Math.min(pageMyFinalAdjLast * pageSizeUserShift, filteredDataItemsMyFinalAdjLast.length)
                                            ) : (
                                                filteredRowDataMyFinalAdjLast.length > 0 ? Math.min(pageMyFinalAdjLast * pageSizeUserShift, filteredRowDataMyFinalAdjLast.length) : 0
                                            )
                                        }{" "}of{" "}
                                        {
                                            gridApi && gridApi.getFilterModel() && Object.keys(gridApi.getFilterModel()).length === 0 ? (
                                                filteredDataItemsMyFinalAdjLast.length
                                            ) : (
                                                filteredRowDataMyFinalAdjLast.length
                                            )
                                        } entries
                                    </Box>
                                    <Box>
                                        <Button onClick={() => handlePageChangeMyFinalAdjLast(1)} disabled={pageMyFinalAdjLast === 1} sx={userStyle.paginationbtn}  > <FirstPageIcon /> </Button>
                                        <Button onClick={() => handlePageChangeMyFinalAdjLast(pageMyFinalAdjLast - 1)} disabled={pageMyFinalAdjLast === 1} sx={userStyle.paginationbtn}  > <NavigateBeforeIcon />  </Button>
                                        {getVisiblePageNumbersMyFinalAdjLast().map((pageNumber, index) => (
                                            <Button
                                                key={index}
                                                onClick={() => pageNumber !== "..." && handlePageChangeMyFinalAdjLast(pageNumber)}
                                                sx={{
                                                ...
                                                className={pageMyFinalAdjLast === pageNumber ? "active" : ""}
                                                disabled={pageMyFinalAdjLast === pageNumber}
                                            >
                                                {pageNumber}
                                            </Button>
                                        ))}
                                        <Button onClick={() => handlePageChangeMyFinalAdjLast(pageMyFinalAdjLast + 1)} disabled={pageMyFinalAdjLast === totalPagesMyFinalAdjLast} sx={userStyle.paginationbtn} > <NavigateNextIcon /> </Button>
                                        <Button onClick={() => handlePageChangeMyFinalAdjLast(totalPagesMyFinalAdjLast)} disabled={pageMyFinalAdjLast === totalPagesMyFinalAdjLast} sx={userStyle.paginationbtn} ><LastPageIcon /> </Button>
                                    </Box>
                                </Box> */}
                            </>
                        }
            ...
            <Popover
                id={idMyFinalAdjLast}
                open={isManageColumnsOpenMyFinalAdjLast}
                anchorElMyFinalAdjLast={anchorElMyFinalAdjLast}
                onClose={handleCloseManageColumnsMyFinalAdjLast}
                anchorOrigin={{ vertical: "bottom", horizontal: "left", }}
            >
                <ManageColumnsContent
                    handleClose={handleCloseManageColumnsMyFinalAdjLast}
                    searchQuery={searchQueryManageMyFinalAdjLast}
                    setSearchQuery={setSearchQueryManageMyFinalAdjLast}
                    filteredColumns={filteredColumnsMyFinalAdjLast}
                    columnVisibility={columnVisibilityMyFinalAdjLast}
                    toggleColumnVisibility={toggleColumnVisibilityMyFinalAdjLast}
                    setColumnVisibility={setColumnVisibilityMyFinalAdjLast}
                    initialColumnVisibility={initialColumnVisibilityMyFinalAdjLast}
                    columnDataTable={columnDataTableMyFinalAdjLast}
                />
            </Popover>

            {/* Search Bar */}
            <Popover
                id={idSearchMyFinalAdjLast}
                open={openSearchMyFinalAdjLast}
                anchorEl={anchorElSearchMyFinalAdjLast}
                onClose={handleCloseSearchMyFinalAdjLast}
                anchorOrigin={{ vertical: 'bottom', horizontal: 'right', }}
            >
                <AdvancedSearchBar columns={columnDataTableMyFinalAdjLast.filter(data => !daysArray.some(column => data.field === `${column.formattedDate} ${column.dayName} Day${column.dayCount}`))} onSearch={applyAdvancedFilterMyFinalAdjLast} initialSearchValue={searchQueryMyFinalAdjLast} handleCloseSearch={handleCloseSearchMyFinalAdjLast} />
            </Popover>
            ...
            <TableContainer component={Paper} sx={userStyle.printcls} >
                <Table sx={{ minWidth: 700 }} aria-label="customized table" ref={componentRefSetTable} id="shiftfinallistpdf">
                    ...
                    <TableBody align="left">
                        {(filteredRowDataMyFinalAdjLast.length > 0 ? filteredRowDataMyFinalAdjLast : filteredDataMyFinalAdjLast) &&
                            (filteredRowDataMyFinalAdjLast.length > 0 ? filteredRowDataMyFinalAdjLast : filteredDataMyFinalAdjLast).map((row, index) => (
                                <TableRow key={index}>
            ...
            <Dialog open={isFilterOpenMyFinalAdjLast} onClose={handleCloseFilterModMyFinalAdjLast} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
                <DialogContent sx={{ textAlign: "center", alignItems: "center", justifyContent: "center" }}>

                    <IconButton
                        aria-label="close"
                        onClick={handleCloseFilterModMyFinalAdjLast}
                        sx={{
                            position: "absolute",
                            right: 8,
                            top: 8,
                ...
                <DialogActions>
                    <Button
                        ...
                        onClick={(e) => {
                            handleExportXLMyFinalAdjLast("filtered")
                        }}
                    >
                    ...
                    <Button autoFocus variant="contained"
                        onClick={(e) => {
                            handleExportXLMyFinalAdjLast("overall")
                        }}
                    >
            ...
            {/*Export pdf Data  */}
            <Dialog open={isPdfFilterOpenMyFinalAdjLast} onClose={handleClosePdfFilterModMyFinalAdjLast} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
                <DialogContent sx={{ textAlign: "center", alignItems: "center", justifyContent: "center" }}>
                    <IconButton
                        aria-label="close"
                        onClick={handleClosePdfFilterModMyFinalAdjLast}
                        sx={{
                            position: "absolute",
                            right: 8,
                            top: 8,
                ...
                <DialogActions>
                    <Button
                        variant="contained"
                        onClick={(e) => {
                            downloadPdfMyFinalAdjLast("filtered")
                            setIsPdfFilterOpenMyFinalAdjLast(false);
                        }}
                    >
                        Export Filtered Data
                    </Button>
                    <Button variant="contained"
                        onClick={(e) => {
                            downloadPdfMyFinalAdjLast("overall")
                            setIsPdfFilterOpenMyFinalAdjLast(false);
                        }}
                    >
                        Export Over All Data

...
function AssignBiometricDevice() {
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "Assigned Biometric Device Card Number List.png");
                })
                .catch((error) => {
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("Assigned Biometric Device Card Number"),
    ...
    const delEmployee = async () => {
        ...
        try {
            let ans = await axios.put(
                `${SERVICE.USER_SINGLE_PWD}/${deleteGroup._id}`,
                {
                    headers: {
                        Authorization: `Bearer ${auth.APIToken}`,
                    },
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Check for an existing card number in the group
        ...
        if (!biometricName.cardnumber || biometricName.cardnumber.trim() === "") {
            // Show alert if the card number is empty
    ...
    let updateby = biometricName?.updatedby;
    let addedby = biometricName?.addedby;
    //------------------------------------------------------
    ...
    const handleprint = useReactToPrint({
        ...
        documentTitle: "Assigned Biometric Device Card Number List",
        pageStyle: "print",
    });
...

        {
            ...
            cellRenderer: (params) => (
                <Grid sx={{ display: "flex" }}>
                    ...
                    {isUserRoleCompare?.includes("dassignbiometricdevicecardnumber") && (
                        <Button
                            sx={userStyle.buttonedit}
                            onClick={() => {
                        ...
                        >
                            <DeleteOutlineOutlinedIcon sx={buttonStyles.buttonedit} />
                        </Button>
                    )}
                    {isUserRoleCompare?.includes("vassignbiometricdevicecardnumber") && (
                        <Button
                            sx={userStyle.buttonedit}
                            onClick={() => {
                    ...
                    {isUserRoleCompare?.includes("iassignbiometricdevicecardnumber") && (
                        <Button
                            sx={userStyle.buttonedit}
                            onClick={() => {
    ...
    //         setAllGroupEdit(
    //             response?.data?.allusers.filter((item) => item._id !== biometricName._id)
    //         );
    //         setSearchQuery("");
    //         setFilterLoader(false);
    //         setTableLoader(false);
    ...
    return (
        <>
            <Box>
                ...
                <Headtitle title={"Assigned Biometric Device"} />
                {/* ****** Header Content ****** */}
                <PageHeading
                    title="Assigned Biometric Device Card Number"
                    modulename="Biometric Device"
                    submodulename="Assigned Biometric Device Card Number"
                    mainpagename=""
                    subpagename=""
                    subsubpagename=""
                />
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={8}>
                                        <Typography sx={userStyle.importheadtext}>
                                            Assigned Biometric Device Card Number List Filter
                                        </Typography>
                                    </Grid>
                                </Grid>
                                <br />
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={8}>
                                    <Typography sx={userStyle.SubHeaderText}>
                                        Assigned Biometric Device Card Number List
                                    </Typography>
                                </Grid>
                ...
                <Box>
                    ...
                    >
                        <Box sx={userStyle.dialogbox}>
                            <>
                                <Typography sx={userStyle.SubHeaderText}>
                                    Edit Assigned Biometric Device Card Number List
                                </Typography>
                                <br />
                                <br />
                                <Grid container spacing={2}>
                ...
                >
                    <Box sx={{ width: "750px", padding: "20px 50px" }}>
                        <>
                            <Typography sx={userStyle.HeaderText}> View Assigned Biometric Device Card Number</Typography>
                            <br /> <br />
                            <Grid container spacing={2}>
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                ...
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <Typography>{biometricName.cardnumber}</Typography>
                                    </FormControl>
                                </Grid>
                            </Grid>
                            <br /> <br /> <br />
                ...
                <ExportData
                    ...
                    itemsTwo={employees ?? []}
                    filename={"Assigned Biometric Device Card Number List"}
                ...
                <InfoPopup
                    ...
                    heading="Assigned Biometric Device Card Info"
                    addedby={addedby}
                    updateby={updateby}
                />

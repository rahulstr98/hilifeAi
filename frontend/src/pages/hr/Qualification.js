...
function Qualification() {
    ...
    const fetchQualifications = async () => {
        ...
        try {
            ...
            setIsQuali(true)
        } catch (err) { setIsQuali(true); handleApiError(err, setPopupContentMalert, setPopupSeverityMalert, handleClickOpenPopupMalert); }
    };
                ...
                <Grid sx={{ display: 'flex' }}>
                    ...
                    {isUserRoleCompare?.includes("dqualification") && (
                        <Button sx={userStyle.buttondelete}
                            onClick={(e) => {
                                rowData(params.row.id, params.row.qualiname)
                    ...
                    <Box sx={userStyle.container}>
                        ...
                        <>
                            <Grid container spacing={2}>
                                ...
                                <Grid item md={4} sm={12} xs={12} mt={3}>
                                    <Grid container spacing={2}>

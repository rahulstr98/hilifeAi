...
import { Box, Typography, OutlinedInput, InputLabel, Dialog, DialogContent, FormGroup, DialogActions, TextareaAutosize, TableCell, TableRow, FormControl, Grid, Paper, Table, TableHead, TableContainer, Button, TableBody, TextField } from '@mui/material';
...
function InternDraftView() {
  ...
  const { isUserRoleCompare, isUserRoleAccess, buttonStyles, workStationSystemName } = useContext(UserRoleAccessContext);
    ...
    try {
      ...
      setCreateRocketChat({
        ...
        roles: response?.data?.sdraft?.rocketchatroles
          ? response?.data?.sdraft?.rocketchatroles?.map((data) => ({
            label: data,
            value: data,
          }))
          : [],
      ...
      setCreateHiConnect({
        createhiconnect: response?.data?.sdraft?.hiconnectid ? true : false,
        hiconnectemail: response?.data?.sdraft?.hiconnectemail ?? '',
        hiconnectroles: response?.data?.sdraft?.hiconnectroles
          ? response?.data?.sdraft?.hiconnectroles?.map((data) => ({
            label: data,
            value: data,
          }))
          : [],
      ...
      setFirst(response?.data?.sdraft?.firstname?.toLowerCase().split(' ').join(''));
      setSecond(response?.data?.sdraft?.lastname?.toLowerCase().split(' ').join(''));
      ...
      setAccessible({
        company: response?.data?.sdraft?.accessiblecompany ? response?.data?.sdraft?.accessiblecompany : '',
        branch: response?.data?.sdraft?.accessiblebranch ? response?.data?.sdraft?.accessiblebranch : '',
        unit: response?.data?.sdraft?.accessibleunit ? response?.data?.sdraft?.accessibleunit : '',
      ...
      setPrimaryWorkStation(response?.data?.sdraft?.workstation[0] === 'Please Select Primary Work Station' ? '' : response?.data?.sdraft?.workstation[0]);
      ...
      setSelectedWorkStation(response?.data?.sdraft?.workstation.slice(1, response?.data?.sdraft?.workstation?.length));
      setSelectedOptionsWorkStation(
        Array.isArray(response?.data?.sdraft?.workstation)
          ? response?.data?.sdraft?.workstation.slice(1, response?.data?.sdraft?.workstation?.length)?.map((x) => ({
            ...x,
            label: x,
            value: x,
          }))
      ...
      setEmployee({
        ...
        callingname: savedEmployee?.callingname === '' || savedEmployee?.callingname == undefined ? savedEmployee?.legalname : savedEmployee?.callingname,
      });
      setEmployeecodenew(savedEmployee.wordcheck === true ? savedEmployee.empcode : '');
      setCheckcode(savedEmployee.wordcheck);

      setValueWorkStation(response?.data?.sdraft?.workstation.slice(1, response?.data?.sdraft?.workstation?.length));
      ...
      //workstation start
      let isIntern = !response?.data?.sdraft?.internstatus ? false : response?.data?.sdraft?.internstatus === 'Moved';

      let boardingLog = response?.data?.sdraft?.boardingLog;
      ...
      let boardFirstLog = isIntern && movetoliveIndex !== -1 && afterArray?.length > 0 ? afterArray[0] : response?.data?.sdraft?.boardingLog?.length > 0 ? response?.data?.sdraft?.boardingLog[0] : undefined;
      ...
      const wfhcount = response?.data?.sdraft?.wfhcount || 0;
      ...
      const updatedData = assignPrimarySecondaryWorkstations([boardFirstLog || response?.data?.sdraft]);

      const systemShortNamesArray = updatedData[0]?.systemshortname.split(', ');

      const [primary, ...secondary] = systemShortNamesArray;

      const employeeCount = Number(response?.data?.sdraft?.employeecount ?? 0) + Number(response?.data?.sdraft?.wfhcount ?? 0);
      setMaxSelections(employeeCount);
      var filteredWorks;
      if (response?.data?.sdraft?.unit === '' && response?.data?.sdraft?.floor === '') {
        filteredWorks = workStationOpt?.filter((u) => u.company === response?.data?.sdraft?.company && u.branch === response?.data?.sdraft?.branch);
      } else if (response?.data?.sdraft?.unit === '') {
        filteredWorks = workStationOpt?.filter((u) => u.company === response?.data?.sdraft?.company && u.branch === response?.data?.sdraft?.branch && u.floor === response?.data?.sdraft?.floor);
      } else if (response?.data?.sdraft?.floor === '') {
        filteredWorks = workStationOpt?.filter((u) => u.company === response?.data?.sdraft?.company && u.branch === response?.data?.sdraft?.branch && u.unit === response?.data?.sdraft?.unit);
      } else {
        filteredWorks = workStationOpt?.filter((u) => u.company === response?.data?.sdraft?.company && u.branch === response?.data?.sdraft?.branch && u.unit === response?.data?.sdraft?.unit && u.floor === response?.data?.sdraft?.floor);
      }
                ...
                <Grid container spacing={2}>
                  <Grid item md={6} sm={12} xs={12}>
                    ...
                    <Grid container sx={{ display: 'flex' }}>
                      ...
                      <Grid item md={9} sm={9} xs={9}>
                        <FormControl size="small" fullWidth>
                          <OutlinedInput readOnly={true} value={employee.firstname} />
                        </FormControl>
                  ...
                  <Grid item md={6} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      ...
                      <OutlinedInput id="component-outlined" value={employee.lastname} readOnly />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      <Typography>Legal Name</Typography>
                      <OutlinedInput id="component-outlined" readOnly value={employee.legalname} />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      <Typography>Calling Name</Typography>
                      <OutlinedInput id="component-outlined" readOnly value={employee.callingname} />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      <Typography>Father Name</Typography>
                      <OutlinedInput id="component-outlined" readOnly value={employee.fathername} />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      <Typography>Mother Name</Typography>
                      <OutlinedInput id="component-outlined" value={employee.mothername} readOnly />
                    </FormControl>
                  </Grid>
                    ...
                    <Grid container spacing={2}>
                      <Grid item md={4} sm={12} xs={12}>
                        <FormControl fullWidth size="small">
                          ...
                          <OutlinedInput id="component-outlined" value={employee.gender} readOnly type="text" size="small" name="dom" />
                        </FormControl>
                      </Grid>
                      <Grid item md={4} sm={12} xs={12}>
                        <FormControl fullWidth size="small">
                          ...
                          <OutlinedInput id="component-outlined" value={employee.maritalstatus} readOnly type="text" size="small" name="dom" />
                        </FormControl>
                      </Grid>
                      {employee.maritalstatus === 'Married' && (
                        <Grid item md={4} sm={6} xs={12}>
                          <FormControl fullWidth size="small">
                            ...
                            <OutlinedInput id="component-outlined" value={employee.dom ? moment(employee.dom)?.format('DD-MM-YYYY') : ''} readOnly type="text" size="small" name="dom" />
                          </FormControl>
                      ...
                      <Grid item md={2.5} sm={6} xs={12}>
                        <FormControl fullWidth size="small">
                          ...
                          <OutlinedInput id="component-outlined" value={employee.dob ? moment(employee.dob)?.format('DD-MM-YYYY') : ''} readOnly type="text" size="small" name="dob" />
                        </FormControl>
                      ...
                      <Grid item md={4} sm={6} xs={12}>
                        <FormControl fullWidth size="small">
                          ...
                          <OutlinedInput id="component-outlined" type="text" placeholder="religion" value={employee?.religion || ''} readOnly />
                        </FormControl>
                      </Grid>
                      <Grid item md={4} sm={6} xs={12}>
                        <FormControl fullWidth size="small">
                          ...
                          <OutlinedInput id="component-outlined" type="text" placeholder="bloodgroup" value={employee.bloodgroup} readOnly />
                        </FormControl>
                      </Grid>
                      <Grid item md={4} sm={12} xs={12}>
                        <FormControl fullWidth size="small">
                          <Typography>Email</Typography>
                          <TextField id="email" type="email" placeholder="Email" value={employee.email} readOnly />
                        </FormControl>
                      </Grid>
                      ...
                      <Grid item md={4} sm={6} xs={12}>
                        <FormControl fullWidth size="small">
                          ...
                          <OutlinedInput id="component-outlined" type="text" placeholder="Location" value={employee.location} readOnly />
                        </FormControl>
                      </Grid>
                      <Grid item md={4} sm={6} xs={12}>
                        <FormControl fullWidth size="small">
                          <Typography>Contact No (personal)</Typography>
                          <OutlinedInput id="component-outlined" type="number" sx={userStyle.input} placeholder="Contact No (personal)" value={employee.contactpersonal} readOnly />
                        </FormControl>
                      ...
                      <Grid item md={4} sm={6} xs={12}>
                        <FormControl fullWidth size="small">
                          ...
                          <OutlinedInput id="component-outlined" type="number" sx={userStyle.input} placeholder="Contact No (Family)" value={employee.contactfamily} readOnly />
                        </FormControl>
                      ...
                      <Grid item md={4} sm={6} xs={12}>
                        <FormControl fullWidth size="small">
                          ...
                          <OutlinedInput id="component-outlined" type="number" sx={userStyle.input} placeholder="Emergency No (Emergency)" value={employee.emergencyno} readOnly />
                        </FormControl>
                      ...
                      <Grid item md={4} sm={6} xs={12}>
                        <FormControl fullWidth size="small">
                          ...
                          <OutlinedInput id="component-outlined" type="Number" sx={userStyle.input} placeholder="Aadhar No" value={employee.aadhar} readOnly />
                        </FormControl>
                      ...
                      <Grid item md={4} sm={12} xs={12}>
                        <FormControl fullWidth size="small">
                          ...
                          <OutlinedInput id="component-outlined" type="text" placeholder="Pan No" value={employee.panstatus} readOnly />
                        </FormControl>
                      </Grid>
                      {employee?.panstatus === 'Have PAN' && (
                        <Grid item md={4} sm={6} xs={12}>
                          <FormControl fullWidth size="small">
                            ...
                            <OutlinedInput id="component-outlined" type="text" placeholder="Pan No" value={employee.panno} readOnly />
                          </FormControl>
                      ...
                      {employee?.panstatus === 'Applied' && (
                        <Grid item md={4} sm={6} xs={12}>
                          <FormControl fullWidth size="small">
                            ...
                            <OutlinedInput id="component-outlined" type="text" placeholder="Pan No" value={employee.panrefno} readOnly />
                          </FormControl>
                  ...
                  <Grid item lg={3} md={3} sm={12} xs={12}>
                    ...
                    <img style={{ height: 120 }} src={croppedImage === '' ? employee.profileimage : croppedImage} alt="" />
                  </Grid>
                </Grid>
              </>
              <br />
              ...
              <Grid container spacing={2}>
                <Grid item md={4} sm={6} xs={12}>
                  {enableLoginName ? (
                    ...
                    <FormControl size="small" fullWidth>
                      <Typography>Login Name</Typography>
                      <OutlinedInput id="component-outlined" type="text" readOnly value={employee.username} />
                    </FormControl>
                  )}
                </Grid>
                <Grid item md={4} sm={12} xs={12}>
                ...
                <Grid item md={4} sm={12} xs={12}>
                  <FormControl size="small" fullWidth>
                    ...
                    <OutlinedInput id="component-outlined" type="text" readOnly value={employee.companyname} />
                  </FormControl>
                </Grid>
              </Grid>{' '}
              <br />
              ...
              <Grid container spacing={2}>
                ...
                {isUserRoleAccess.role.includes('Manager') ? (
                  <Grid item md={4} sm={6} xs={12}>
                    <FormControl fullWidth size="small">
                      ...
                      <OutlinedInput value={employee.enquirystatus} readOnly={true} />
                    </FormControl>
                  </Grid>
                ...
                <Grid item md={4} sm={6} xs={12}>
                  <FormControl fullWidth size="small">
                    ...
                    <OutlinedInput id="component-outlined" type="text" value={employee.doj ? moment(employee.doj)?.format('DD-MM-YYYY') : ''} readOnly />
                ...
                <Grid item md={4} sm={6} xs={12}>
                  <FormControl fullWidth size="small">
                    ...
                    <OutlinedInput id="component-outlined" type="text" value={employee.dot ? moment(employee.dot)?.format('DD-MM-YYYY') : ''} readOnly />
                  </FormControl>
                </Grid>
                ...
                {employee.shifttype === 'Standard' ? (
                  <>
                    <Grid item md={4} sm={6} xs={12}>
                      ...
                      <FormControl fullWidth size="small">
                        <OutlinedInput value={employee.shiftgrouping} readOnly={true} />
                      </FormControl>
                    </Grid>
                    <Grid item md={4} sm={6} xs={12}>
                      <Typography>Shift</Typography>
                      <FormControl fullWidth size="small">
                        <OutlinedInput value={employee.shifttiming} readOnly={true} />
                      </FormControl>
                    </Grid>
                        ...
                        todo?.map((todo, index) => (
                          <Grid container spacing={2} key={index} sx={{ paddingTop: '5px' }}>
                            ...
                            <Grid item md={3} sm={6} xs={12}>
                              <FormControl fullWidth size="small">
                                <OutlinedInput value={todo.shiftmode} readOnly={true} />
                              </FormControl>
                            </Grid>
                            {todo.shiftmode === 'Week Off' ? (
                              ...
                              <>
                                <Grid item md={3} sm={6} xs={12}>
                                  <FormControl fullWidth size="small">
                                    <OutlinedInput value={todo.shiftgrouping} readOnly={true} />
                                  </FormControl>
                                </Grid>
                                <Grid item md={3} xs={6} sm={6}>
                                  <FormControl fullWidth size="small">
                                    {/* Fetching options */}
                                    <OutlinedInput value={todo.shifttiming} type="text" readOnly />
                                  </FormControl>
                                </Grid>
                              </>
                            )}
                ...
                {employee.workmode !== 'Remote' ? (
                  <>
                    ...
                    <Grid item md={4} sm={12} xs={12}>
                      ...
                      <Grid>
                        <FormGroup>
                          <FormControlLabel control={<Checkbox checked={employee.workstationofficestatus === true} />} readObnly label="Work Station Other" />
                        </FormGroup>
                      </Grid>
                    </Grid>
                    <Grid item md={4} sm={12} xs={12}>
                      <FormControl size="small" fullWidth>
                        ...
                        <OutlinedInput value={primaryWorkStationInput} readOnly={true} />
                      </FormControl>
                    </Grid>
                  </>
                ) : null}
                ...
                <Grid container spacing={2}>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      ...
                      <OutlinedInput id="component-outlined" type="text" value={employee?.paddresstype} readOnly />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      <Typography>Personal Prefix</Typography>
                      <OutlinedInput id="component-outlined" type="text" value={employee?.ppersonalprefix} readOnly />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      <Typography>Reference Name</Typography>
                      <OutlinedInput id="component-outlined" type="text" value={employee?.presourcename} readOnly />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl size="small" fullWidth>
                      <Typography>Country</Typography>
                      <OutlinedInput value={selectedCountryp?.name} readOnly={true} />
                    </FormControl>
                  ...
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl size="small" fullWidth>
                      ...
                      <OutlinedInput id="component-outlined" type="number" sx={userStyle.input} readOnly value={employee.ppincode} />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                  ...
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl size="small" fullWidth>
                      ...
                      <OutlinedInput id="component-outlined" type="text" sx={userStyle.input} readOnly value={employee?.pgpscoordination} />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      <Typography>Landmark & Positional Prefix</Typography>
                      <OutlinedInput id="component-outlined" type="text" value={employee?.plandmarkandpositionalprefix} readOnly />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      <Typography>Landmark Name</Typography>
                      <OutlinedInput id="component-outlined" type="text" readOnly value={employee.plandmark} />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      <Typography>House/Flat No</Typography>
                      <OutlinedInput id="component-outlined" type="text" value={employee.pdoorno} readOnly />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      <Typography>Street/Road Name</Typography>
                      <OutlinedInput id="component-outlined" type="text" readOnly value={employee.pstreet} />
                    </FormControl>
                  </Grid>
                  <Grid item md={3} sm={12} xs={12}>
                    <FormControl fullWidth size="small">
                      <Typography>Locality/Area Name</Typography>
                      <OutlinedInput id="component-outlined" type="text" readOnly value={employee.parea} />
                    </FormControl>
                  </Grid>
                ...
                <>
                  <Grid container spacing={2}>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        <Typography>Address Type</Typography>
                        <OutlinedInput id="component-outlined" type="text" value={employee?.caddresstype} readOnly />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        <Typography>Personal Prefix</Typography>
                        <OutlinedInput id="component-outlined" type="text" value={employee?.cpersonalprefix} readOnly />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        <Typography>Reference Name</Typography>
                        <OutlinedInput id="component-outlined" type="text" value={employee?.cresourcename} readOnly />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl size="small" fullWidth>
                        <Typography>Country</Typography>
                        <OutlinedInput value={selectedCountryc?.name} readOnly={true} />
                      </FormControl>
                      {selectedCountryc?.name === 'India' && <FormControlLabel control={<Checkbox checked={employee?.cgenerateviapincode} readOnly isDisabled={true} />} label="Generate Via Pincode" />}
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl size="small" fullWidth>
                        <Typography>Pincode</Typography>
                        <OutlinedInput id="component-outlined" type="number" sx={userStyle.input} readOnly value={employee.cpincode} />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                    ...
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl size="small" fullWidth>
                        <Typography>GPS Coordinations</Typography>
                        <OutlinedInput id="component-outlined" type="text" sx={userStyle.input} readOnly value={employee?.cgpscoordination} />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        <Typography>Landmark & Positional Prefix</Typography>
                        <OutlinedInput id="component-outlined" type="text" value={employee?.clandmarkandpositionalprefix} readOnly />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        <Typography>Landmark Name</Typography>
                        <OutlinedInput id="component-outlined" type="text" readOnly value={employee.clandmark} />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        <Typography>House/Flat No</Typography>
                        <OutlinedInput id="component-outlined" type="text" value={employee.cdoorno} readOnly />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        <Typography>Street/Road Name</Typography>
                        <OutlinedInput id="component-outlined" type="text" readOnly value={employee.cstreet} />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        <Typography>Locality/Area Name</Typography>
                        <OutlinedInput id="component-outlined" type="text" readOnly value={employee.carea} />
                      </FormControl>
                    </Grid>
                  </Grid>
                </>
                  ...
                  <div key={index}>
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item md={4} xs={12} sm={12} sx={{ display: 'flex' }}>
                        <FormControl fullWidth size="small">
                          <Typography>Status</Typography>
                          <OutlinedInput id="component-outlined" type="text" value={data.accountstatus ?? 'In-Active'} placeholder="Please Enter IFSC Code" readOnly />
                        </FormControl>
                      </Grid>
              ...
              <Grid container spacing={1}>
                ...
                <Grid item md={3} xs={12} sm={4}>
                  <FormControl fullWidth>
                    <OutlinedInput id="component-outlined" type="text" readOnly value={assignExperience.updatedate ? moment(assignExperience.updatedate)?.format('DD-MM-YYYY') : ''} />
                  </FormControl>
                </Grid>
              </Grid>
              <br />
              <Grid container spacing={1}>
                <Grid item md={4} xs={12} sm={4}>
                  <FormControl fullWidth>
                    ...
                    <OutlinedInput value={assignExperience.expmode} readOnly={true} />
                  </FormControl>
                </Grid>
                <Grid item md={4} xs={12} sm={4}>
                  <FormControl fullWidth size="small">
                    <Typography>Value (In Months)</Typography>
                    <OutlinedInput id="component-outlined" type="text" readOnly value={assignExperience.expval} />
                  </FormControl>
                </Grid>
              </Grid>
              <br />
              <Grid container spacing={1}>
                <Grid item md={3} xs={12} sm={4}>
                  <FormControl fullWidth>
                    ...
                    <OutlinedInput id="component-outlined" type="text" readOnly value="Exp Stop" />
                  </FormControl>
                </Grid>
                ...
                <Grid item md={3} xs={12} sm={4}>
                  <FormControl fullWidth>
                    ...
                    <OutlinedInput id="component-outlined" type="text" readOnly value={assignExperience.endexp} />
                  </FormControl>
                </Grid>
                ...
                {assignExperience.endexp === 'Yes' ? (
                  <>
                    <Grid item md={3} xs={12} sm={4}>
                      ...
                      <OutlinedInput id="component-outlined" type="text" readOnly value={assignExperience.endexpdate ? moment(assignExperience.endexpdate)?.format('DD-MM-YYYY') : ''} />
                    </Grid>
                  </>
                ) : null}
              </Grid>
              ...
              <Grid container spacing={1}>
                <Grid item md={3} xs={12} sm={4}>
                  <FormControl fullWidth>
                    ...
                    <OutlinedInput id="component-outlined" type="text" readOnly value="Target Stop" />
                  </FormControl>
                </Grid>
                ...
                <Grid item md={3} xs={12} sm={4}>
                  <FormControl fullWidth>
                    ...
                    <OutlinedInput id="component-outlined" type="text" readOnly value={assignExperience.endtar} />
                  </FormControl>
                </Grid>
                ...
                {assignExperience.endtar === 'Yes' ? (
                  <>
                    <Grid item md={3} xs={12} sm={4}>
                      ...
                      <OutlinedInput id="component-outlined" type="text" readOnly value={assignExperience.endtardate ? moment(assignExperience.endtardate)?.format('DD-MM-YYYY') : ''} />
                    </Grid>
                  </>
                ) : null}
              </Grid>
            ...
            <Box sx={userStyle.dialogbox}>
              ...
              <Grid container spacing={2}>
                <Grid item md={4} xs={12} sm={12}>
                  ...
                  <FormControl fullWidth size="small">
                    <OutlinedInput id="component-outlined" type="text" value={loginNotAllot?.process} readOnly />
                  </FormControl>
                </Grid>
                <Grid item md={4} xs={12} sm={12}>
                  <Typography>Process Type</Typography>
                  <FormControl fullWidth size="small">
                    <OutlinedInput id="component-outlined" type="text" value={loginNotAllot?.processtype} readOnly />
                  </FormControl>
                </Grid>
                <Grid item md={4} xs={12} sm={12}>
                  <Typography>Process Duration</Typography>
                  <FormControl fullWidth size="small">
                    <OutlinedInput id="component-outlined" type="text" value={loginNotAllot?.processduration} readOnly />
                  </FormControl>
                </Grid>
                <Grid item md={4} xs={12} sm={6}>
                  ...
                  <Grid container spacing={1}>
                    <Grid item md={6} xs={12} sm={6}>
                      <FormControl fullWidth size="small">
                        <OutlinedInput id="component-outlined" type="text" value={loginNotAllot?.time || ''} readOnly />
                      </FormControl>
                    </Grid>
                    <Grid item md={6} xs={12} sm={6}>
                      <FormControl fullWidth size="small">
                        <OutlinedInput id="component-outlined" type="text" value={loginNotAllot?.timemins || ''} readOnly />
                      </FormControl>
                    </Grid>
                  </Grid>
                </Grid>
                <Grid item md={4} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    ...
                    <OutlinedInput id="component-outlined" type="text" value={overallgrosstotal} readOnly />
                  </FormControl>
                </Grid>
                <Grid item md={4} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    <Typography>Mode Experience</Typography>
                    <OutlinedInput id="component-outlined" type="text" value={modeexperience} readOnly />
                  </FormControl>
                </Grid>
                <Grid item md={4} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    <Typography>Target Experience</Typography>
                    <OutlinedInput id="component-outlined" type="text" value={targetexperience} readOnly />
                  </FormControl>
                </Grid>
                <Grid item md={4} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    <Typography>Target Points</Typography>
                    <OutlinedInput id="component-outlined" type="text" value={targetpts} readOnly />
                  </FormControl>
                </Grid>
              </Grid>
              <br />
                ...
                <div key={index}>
                  ...
                  <Grid container spacing={2}>
                    <Grid item md={4} xs={12} sm={6}>
                      <FormControl fullWidth size="small">
                        <Typography>Company</Typography>
                        <OutlinedInput id="component-outlined" type="text" value={datas.fromcompany ?? ''} readOnly />
                      </FormControl>
                    </Grid>
                    <Grid item md={4} xs={12} sm={6}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput id="component-outlined" type="text" value={datas.frombranch ?? ''} readOnly />
                      </FormControl>
                    </Grid>
                    <Grid item md={4} xs={12} sm={6}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput id="component-outlined" type="text" value={datas.fromunit ?? ''} readOnly />
                      </FormControl>
                    </Grid>
                  </Grid>
                  <br />
              ...
              <Grid container spacing={2}>
                <Grid item md={4} xs={12} sm={12}>
                  <FormControl fullWidth size="small">
                    ...
                    <FormControlLabel control={<Checkbox checked={createRocketChat?.create} disabled={true} />} label="Create Account" />
                  </FormControl>
                </Grid>

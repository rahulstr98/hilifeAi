...
function DeactivateInternlist() {
  ...
  const verifySubmit = async (from) => {
    ...
    if (!verifyDetails.firstname) {
      ...
      !PanValidate(verifyDetails?.panno) &&
      ...
      !verifyDetails?.samesprmnt && (!verifyDetails?.cdoorno ||
    ...
    try {
      ...
      if (userDetails !== "Un-Hold" && empaddform?.workmode === "Internship") {
        ...
        const country = Country.getAllCountries().find(
          (country) => country.name === empaddform.ccountry
        );
        const state = State.getStatesOfCountry(country?.isoCode).find(
          (state) => state.name === empaddform.cstate
        );
        const city = City.getCitiesOfState(
          state?.countryCode,
          state?.isoCode
        ).find((city) => city.name === empaddform.ccity);

        // Find the corresponding Country, State, and City objects
        const countryp = Country.getAllCountries().find(
          (country) => country.name === empaddform.pcountry
        );
        const statep = State.getStatesOfCountry(country?.isoCode).find(
          (state) => state.name === empaddform.pstate
        );
        const cityp = City.getCitiesOfState(
          state?.countryCode,
          state?.isoCode
        ).find((city) => city.name === empaddform.pcity);
  ...
  return (
    <Box>
      ...
      <PageHeading
        ...
        subsubpagename="Deactivate Intern List"
      />
                  ...
                  <OutlinedInput
                    ...
                    onChange={(e) => {
                      ...
                      if (regex.test(inputValue) || inputValue === "") {
                        setVerifyDetails((prev) => ({ ...prev, contactpersonal: inputValue }));
                      }
                    }}
                  />
                </FormControl>
                ...
                <FormControl fullWidth size="small">
                  ...
                  <OutlinedInput
                    ...
                    onChange={(e) => {
                      ...
                      const inputValue = e.target.value?.slice(0, 10);
                      if (regex.test(inputValue) || inputValue === "") {
                        setVerifyDetails((prev) => ({ ...prev, contactfamily: inputValue }));
                      }
                    }}
                  />
                </FormControl>
                ...
                <FormControl fullWidth size="small">
                  ...
                  <OutlinedInput
                    ...
                    onChange={(e) => {
                      ...
                      const inputValue = e.target.value?.slice(0, 10);
                      if (regex.test(inputValue) || inputValue === "") {
                        setVerifyDetails((prev) => ({ ...prev, emergencyno: inputValue }));
                      }
                    }}
                  />
                </FormControl>
              ...
              <Grid item md={4} sm={12} xs={12}>
                <FormControl fullWidth size="small">
                  ...
                  <Selects
                    ...
                    value={{
                      label:
                        verifyDetails.panstatus === "" ||
                          verifyDetails.panstatus == undefined
                          ? "Select PAN Status"
                          : verifyDetails.panstatus,
                      value:
                        verifyDetails.panstatus === "" ||
                    ...
                    <OutlinedInput
                      ...
                      onChange={(e) => {
                        if (e.target.value.length < 11) {
                          setVerifyDetails((prev) => ({ ...prev, panno: e.target.value, }));
                        }
                      }}
                    />
                  </FormControl>
                    ...
                    <OutlinedInput
                      ...
                      onChange={(e) => {
                        if (e.target.value.length < 16) {
                          setVerifyDetails((prev) => ({ ...prev, panrefno: e.target.value, }));
                        }
                      }}
                    />
                  </FormControl>
                    ...
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput
                          ...
                          onChange={(e) => {
                            setVerifyDetails((prev) => ({ ...prev, pdoorno: e.target.value }));
                          }}
                        />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput
                          ...
                          onChange={(e) => {
                            setVerifyDetails((prev) => ({ ...prev, pstreet: e.target.value }));
                          }}
                        />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput
                          ...
                          onChange={(e) => {
                            setVerifyDetails((prev) => ({ ...prev, parea: e.target.value }));
                          }}
                        />
                      </FormControl>
                    </Grid>
                    ...
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl fullWidth size="small">
                        ...
                        <OutlinedInput
                          ...
                          onChange={(e) => {
                            setVerifyDetails((prev) => ({ ...prev, ptaluk: e.target.value }));
                          }}
                        />
                      </FormControl>
                    </Grid>
                    <Grid item md={3} sm={12} xs={12}>
                      <FormControl size="small" fullWidth>
                        ...
                        <OutlinedInput
                          ...
                          onChange={(e) => {
                            setVerifyDetails((prev) => ({ ...prev, ppost: e.target.value }));
                          }}
                        />
                      </FormControl>
                    </Grid>
                      ...
                      <FormControl size="small" fullWidth>
                        ...
                        <OutlinedInput
                          ...
                          onChange={(e) => {
                            ...
                            if (regex.test(inputValue) || inputValue === "") {
                              setVerifyDetails((prev) => ({ ...prev, ppincode: inputValue }));
                            }
                          }}
                        />
                      </FormControl>
                      ...
                      <Grid item md={3} sm={12} xs={12}>
                        <FormControl fullWidth size="small">
                          ...
                          <OutlinedInput
                            ...
                            onChange={(e) => {
                              setVerifyDetails((prev) => ({ ...prev, carea: e.target.value }));
                            }}
                          />
                        </FormControl>
                      </Grid>
                      ...
                      <Grid item md={3} sm={12} xs={12}>
                        <FormControl size="small" fullWidth>
                          ...
                          <OutlinedInput
                            ...
                            onChange={(e) => {
                              setVerifyDetails((prev) => ({ ...prev, cpost: e.target.value }));
                            }}
                          />
                        </FormControl>
                      </Grid>
                        ...
                        <FormControl size="small" fullWidth>
                          ...
                          <OutlinedInput
                            ...
                            onChange={(e) => {
                              ...
                              const inputValue = e?.target?.value?.slice(0, 6);
                              if (regex.test(inputValue) || inputValue === "") {
                                setVerifyDetails((prev) => ({ ...prev, cpincode: inputValue }));
                              }
                            }}
                          />
                        </FormControl>

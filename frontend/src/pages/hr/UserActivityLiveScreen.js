...
function UserActivityLiveScreen() {
  ...
  let exportColumnNames = ["Employeename", "Employeecode", "Username", "Devicename", "Company", "Branch", "Unit", "Team", "Department", "Macaddress", "Localip", "Timestamp", "Status", "Screen Sharing"];
  let exportRowValues = ["employeename", "employeecode", "username", "devicename", "company", "branch", "unit", "team", "department", "macaddress", "localip", "timestamp", "status", "live"];

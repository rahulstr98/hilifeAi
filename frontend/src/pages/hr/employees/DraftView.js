...
import { Box, Typography, OutlinedInput, InputLabel, Dialog, DialogContent, TextareaAutosize, TableCell, TableRow, FormGroup, DialogActions, FormControl, Grid, Paper, Table, TableHead, TableContainer, Button, TableBody, TextField } from '@mui/material';
...
function DraftView() {
 ...
 const downloadFile = async (filename) => {
  ...
  const { isUserRoleCompare, isUserRoleAccess, workStationSystemName } = useContext(UserRoleAccessContext);

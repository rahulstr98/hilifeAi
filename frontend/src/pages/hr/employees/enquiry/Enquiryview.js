...
import { Box, Typography, OutlinedInput, InputLabel, Dialog, DialogContent,IconButton, FormGroup, DialogActions, TextareaAutosize, TableCell, TableRow, FormControl, Grid, Paper, Table, TableHead, TableContainer, Button, TableBody, TextField } from '@mui/material';
...
import { candidate_educational_upload_status} from '../../../../components/Componentkeyword';
...
function Enquiryview() {
  ...
  const fetchWorkStation = async () => {
   ...
   const fetchCandidatedocumentdropdowns = async () => {
              try {
                ...
                let docresult = doccategory?.data?.candidatedocumentcategory?.filter(data => data?.status === "Employee")?.map(item => ({
                  ...item,
  ...
  const fetchHandlerEdit = async () => {
    try {
      ...
      setLoginNotAllot(response?.data?.suser);
       ...
       let desig = await fetchCandidatedocumentdropdowns();
             setEduTodo(responsenew?.data?.semployeedocument?.eduTodo || []);
                  ...
                  setFiles(responsenew?.data?.semployeedocument?.files?.length > 0 ?
      ...
      setPrimaryWorkStation(response?.data?.suser?.workstation[0] === 'Please Select Primary Work Station' ? '' : response?.data?.suser?.workstation[0]);
              ...
              <>
                <Grid container spacing={2}>
                  ...
                  <Grid item lg={3} md={3} sm={12} xs={12}>
                    ...
                    <img style={{ height: 120 }} src={employee.profileimage} alt="" />
                  </Grid>
                </Grid>
              </>
              <br />
                ...
                {employee.shifttype === 'Standard' ? (
                  <>
                    <Grid item md={4} sm={6} xs={12}>
                      ...
                      <FormControl fullWidth size="small">
                        <OutlinedInput value={employee?.boardingLog[0]?.shiftgrouping} readOnly={true} />
                      </FormControl>
                    </Grid>
                    <Grid item md={4} sm={6} xs={12}>
                      <Typography>Shift</Typography>
                      <FormControl fullWidth size="small">
                        <OutlinedInput value={employee?.boardingLog[0]?.shifttiming} readOnly={true} />
                      </FormControl>
                    </Grid>
          ...
          <Grid item md={1} xs={12} sm={12} container alignItems="center">
            ...
            <Grid item md={10} xs={12} sm={12}>
                      <Box sx={userStyle.container}>
                                   <TodosAccordion todoscheck={files} setTodoscheck={setFiles} loading={false} handleCandidateUploadForIndex={handleCandidateUploadForIndex} colourStyles={colourStyles} candidate_educational_upload_status={candidate_educational_upload_status} renderFilePreview={renderFilePreviewMulterUploaded} readOnly={true} />
                                                                      ...
                                                                      <StyledTableCell>{todo.documenttype || ''}</StyledTableCell>
                                                                                              ...
                                                                                              <StyledTableCell>
                                                                                                {todo.status === 'Pending' ? (
                                                                                                    ...
                                                                                                    >
                                                                                                      ...
                                                                                                      {todo.file && todo.status === "Uploaded" && (
                                                                                                                                    ...
                                                                                                                                    {todo.filename && todo.status === "Uploaded" && (
                                                                                                                                      <IconButton
                                                                                                                                        onClick={() => renderFilePreviewMulterUploaded(todo)} size="small"
                                                                                                                                        sx={{ ml: 1 }}
                                                                                                                                      >
                                                                                                                                        <VisibilityIcon sx={{ color: '#0B7CED' }} />
                                                                                                                                      </IconButton>
                                                                                                 ...
                                                                                                 <StyledTableCell>{(todo?.verificationdetails?.length === 0 || !todo?.verificationdetails) ? "Not Verified" : (todo?.verificationdetails?.length > 0 && todo?.verificationdetails[todo?.verificationdetails?.length - 1]?.verified) ? "Verified" : (todo?.verificationdetails?.length > 0 && !todo?.verificationdetails[todo?.verificationdetails?.length - 1]?.verified) ? `Rejected - ${(todo?.verificationdetails[todo?.verificationdetails?.length - 1]?.reason || '')}` : ""} {todo.filename && <IconButton onClick={() => renderFilePreviewMulterUploaded(todo)} size="small" color="primary">
                                                                ...
                                                                <StyledTableRow key={index}>
                                                                  ...
                                                                  <StyledTableCell align="center">{addtodo.remarks}</StyledTableCell>
                                                                    <StyledTableCell>{addtodo.status || ''}</StyledTableCell>
                                                                                                ...
                                                                                                <>
                                                                                                  ...
                                                                                                  >
                                                                                                    ...
                                                                                                    {addtodo.file && addtodo.status === "Uploaded" && (
                                                                                                                                     <IconButton
                                                                                                                                       onClick={() => window.open(URL.createObjectURL(addtodo.file), '_blank')}
                                                                                                                                       size="small"
                                                                                                                                       sx={{ ml: 1 }}
                                                                                                                                     >
                                                                                                                                       <VisibilityIcon sx={{ color: '#0B7CED' }} />
                                                                                                                                   ...
                                                                                                                                   {addtodo.filename && addtodo.status === "Uploaded" && (
                                                                                                                                     <IconButton
                                                                                                                                       onClick={() => renderFilePreviewMulterUploaded(addtodo)} size="small"
                                                                                                                                       sx={{ ml: 1 }}
                                                                                                                                     >
                                                                                                                                       <VisibilityIcon sx={{ color: '#0B7CED' }} />
                                                                                                                                     </IconButton>
                                                                                            ...
                                                                                            <StyledTableCell>{(addtodo?.verificationdetails?.length === 0 || !addtodo?.verificationdetails) ? "Not Verified" : (addtodo?.verificationdetails?.length > 0 && addtodo?.verificationdetails[addtodo?.verificationdetails?.length - 1]?.verified) ? "Verified" : (addtodo?.verificationdetails?.length > 0 && !addtodo?.verificationdetails[addtodo?.verificationdetails?.length - 1]?.verified) ? `Rejected - ${(addtodo?.verificationdetails[addtodo?.verificationdetails?.length - 1]?.reason || '')}` : ""} {addtodo.filename && <IconButton onClick={() => renderFilePreviewMulterUploaded(addtodo)} size="small" color="primary">
                                                                                                                         <VisibilityOutlinedIcon />
                                                                                                                       </IconButton>}</StyledTableCell>
                                                               ...
                                                               workhistTodo?.map((todo, index) => (
                                                                 <StyledTableRow key={index}>
                                                                   ...
                                                                   <StyledTableCell align="center">{todo.reasonTodo}</StyledTableCell>
                                                                    <StyledTableCell>
                                                                                               {todo?.documenttype || ''}
                                                                                               {todo?.documenttype === 'Pay Slip' && todo?.payslipfrom && todo?.payslipto && (
                                                                                                 ` (${todo.payslipfrom} to ${todo.payslipto})`
                                                                                               )}
                                                                                             </StyledTableCell>
                                                                                             <StyledTableCell>{todo.status || ''}</StyledTableCell>
            ...
            <br />
               {salaryOption === 'Experience Based' ? (
                                   <Box sx={userStyle.dialogbox}>
                                     ...
                                     <br />
                                     <Grid container spacing={1}>
                                       <Grid item md={12} xs={12} sm={12}> <div
                                         style={{
                                           display: "flex",
                                           justifyContent: "center",
                                           alignItems: "center",
                                       ...
                                       <Grid container spacing={2}>
                                         ...
                                         <Grid item md={3} xs={12} sm={12}>
                                           <FormControl fullWidth size="small">
                                             ...
                                             <OutlinedInput id="component-outlined" type="text" disabled={salarySetUpForm.mode === 'Auto'} placeholder="Please Enter Gross" value={formValue.gross} readOnly={true} />
                                           </FormControl>
                                         </Grid>
                                         ...
                                         <Grid item md={3} xs={12} sm={12}>
                                           <FormControl fullWidth size="small">
                                             ...
                                             <OutlinedInput id="component-outlined" type="text" disabled={salarySetUpForm.mode === 'Auto'} placeholder="Please Enter Basic" value={formValue.basic} readOnly={true} />
                                           </FormControl>
                                         </Grid>
                                         <Grid item md={3} xs={12} sm={12}>
                                           <FormControl fullWidth size="small">
                                             <Typography>HRA</Typography>
                                             <OutlinedInput id="component-outlined" type="text" disabled={salarySetUpForm.mode === 'Auto'} placeholder="Please Enter HRA" value={formValue.hra} readOnly={true} />
                                           </FormControl>
                                         </Grid>
                                         <Grid item md={3} xs={12} sm={12}>
                                           <FormControl fullWidth size="small">
                                             <Typography>Conveyance</Typography>
                                             <OutlinedInput id="component-outlined" type="text" disabled={salarySetUpForm.mode === 'Auto'} placeholder="Please Enter Conveyance" value={formValue.conveyance} readOnly={true} />
                                           </FormControl>
                                         </Grid>
                                         <Grid item md={3} xs={12} sm={12}>
                                           <FormControl fullWidth size="small">
                                             <Typography>Medical Allowance</Typography>
                                             <OutlinedInput id="component-outlined" type="text" disabled={salarySetUpForm.mode === 'Auto'} placeholder="Please Enter Medical Allowance" value={formValue.medicalallowance} readOnly={true} />
                                           </FormControl>
                                         </Grid>
                                         <Grid item md={3} xs={12} sm={12}>
                                           <FormControl fullWidth size="small">
                                             <Typography>Production Allowance</Typography>
                                             <OutlinedInput id="component-outlined" type="text" disabled={salarySetUpForm.mode === 'Auto'} placeholder="Please Enter Production Allowance" value={formValue.productionallowance} readOnly={true} />
                                           </FormControl>
                                         </Grid>
                                         <Grid item md={3} xs={12} sm={12}>
                                           <FormControl fullWidth size="small">
                                             <Typography>Production Allowance 2</Typography>
                                             <OutlinedInput id="component-outlined" type="text" disabled={salarySetUpForm.mode === 'Auto'} placeholder="Please Enter Production Allowance 2" value={formValue.productionallowancetwo} readOnly={true} />
                                           </FormControl>
                                         </Grid>
                                         <Grid item md={3} xs={12} sm={12}>
                                           <FormControl fullWidth size="small">
                                             <Typography>Other Allowance</Typography>
                                             <OutlinedInput id="component-outlined" type="text" disabled={salarySetUpForm.mode === 'Auto'} placeholder="Please Enter Other Allowance" value={formValue.otherallowance} readOnly={true} />
                                           </FormControl>
                                         </Grid>

...
function BiometricUnmatchedUserAttendanceReport() {
  ...
  const sendRequest = async () => {
    ...
    try {
      const response = await axios.post(
        SERVICE.BIOMETRIC_UNMATCHED_USERS_ATTENDANCE_REPORT_CHECK,
        {
          headers: {
            Authorization: `Bearer ${auth.APIToken}`,
          },
      ...
      const answer = response?.data?.answer?.map((item, index) => ({
      ...
      cellRenderer: (params) => (
        <Grid sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          {isUserRoleCompare?.includes(
            "vbiometricunmatcheduserattendancereport"
          ) && (
            <>
              <Button
  ...
  return (
    <Box>
      ...
      />
      {isUserRoleCompare?.includes(
        "lbiometricunmatcheduserattendancereport"
      ) && (
        <Box sx={userStyle.selectcontainer}>
          <>
            <Typography sx={userStyle.importheadtext}>
              Biometric Unmatched User Attendance Report Filter
            </Typography>
            <br />
          ...
          <Box sx={userStyle.container}>
            ...
            <Grid container spacing={2} style={userStyle.dataTablestyle}>
              ...
              >
                <Box>
                  {isUserRoleCompare?.includes(
                    "excelbiometricunmatcheduserattendancereport"
                  ) && (
                    <>
                      <Button
                        onClick={(e) => {
                  ...
                  {isUserRoleCompare?.includes(
                    "csvbiometricunmatcheduserattendancereport"
                  ) && (
                    <>
                      <Button
                        onClick={(e) => {
                  ...
                  {isUserRoleCompare?.includes(
                    "printbiometricunmatcheduserattendancereport"
                  ) && (
                    <>
                  ...
                  {isUserRoleCompare?.includes(
                    "pdfbiometricunmatcheduserattendancereport"
                  ) && (
                    <>
                      <Button
                        sx={userStyle.buttongrp}
                  ...
                  {isUserRoleCompare?.includes(
                    "imagebiometricunmatcheduserattendancereport"
                  ) && (
                    <Button
                      sx={userStyle.buttongrp}
            ...
            <Grid container spacing={2}>
              <Grid item md={12} xs={12} sm={12}>
                ...
                >
                  <Box>
                    {isUserRoleCompare?.includes(
                      "excelbiometricbranchwiseexitreport"
                    ) && (
                      <>
                    ...
                    {isUserRoleCompare?.includes(
                      "csvbiometricbranchwiseexitreport"
                    ) && (
                      <>
                    ...
                    {isUserRoleCompare?.includes(
                      "printbiometricbranchwiseexitreport"
                    ) && (
                      <>
                        <Button
                          sx={userStyle.buttongrp}
                    ...
                    {isUserRoleCompare?.includes(
                      "pdfbiometricbranchwiseexitreport"
                    ) && (
                      <>
                        <Button
                          sx={userStyle.buttongrp}
                    ...
                    {isUserRoleCompare?.includes(
                      "imagebiometricbranchwiseexitreport"
                    ) && (
                      <Button
                        sx={userStyle.buttongrp}
                    ...
                    <TableBody>
                      {AttendanceList?.data?.map((item, i) => (
                        <StyledTableRow>
                          ...
                          <StyledTableCell style={tableBodyCellStyle}>
                            {" "}
                            {item.outTimeVerifiedDevice}
                          </StyledTableCell>
                          <StyledTableCell style={tableBodyCellStyle}>
                            {" "}
                            {item.outTimeVerified}
                          </StyledTableCell>
                          <StyledTableCell style={tableBodyCellStyle}>
                            {" "}
                            {item.totalHours}
                          ...
                          <StyledTableCell style={tableBodyCellStyle}>
                            {" "}
                            {item.breakHours ? item?.breakHours : "-"}
                          </StyledTableCell>
                        </StyledTableRow>
                      ))}
                    </TableBody>

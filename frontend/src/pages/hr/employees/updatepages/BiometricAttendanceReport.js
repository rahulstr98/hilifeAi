...
function BiometricAttendanceReport() {
    ...
    const sendRequest = async () => {
        ...
        try {
            const response = await axios.post(SERVICE.BIOMETRIC_USERS_ATTENDANCE_REPORT_CHECK, {
                headers: {
                    Authorization: `Bearer ${auth.APIToken}`,
                },

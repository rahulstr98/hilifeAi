...
function BiometricVisitorsAttendanceReport() {
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("BiometricVisitorsAttendanceReport"),
    ...
    const sendRequest = async () => {
        ...
        try {
            const response = await axios.post(SERVICE.BIOMETRIC_VISITORS_ATTENDANCE_REPORT_CHECK, {
                headers: {
                    Authorization: `Bearer ${auth.APIToken}`,
                },
    ...
    const handleCaptureImagePopUp = () => {
        if (componentRefPopUp.current) {
            html2canvas(componentRefPopUp.current).then((canvas) => {
                canvas.toBlob((blob) => {
                    saveAs(blob, "BiometricVisitorsAttendanceReport.png");
                });
            });
        }
    };
    ...
    // Excel
    const fileName = "BiometricVisitorsAttendanceReport";
    //print...
    const componentRef = useRef();
    const handleprint = useReactToPrint({
        content: () => componentRef.current,
        documentTitle: "Biometric Visitors Attendance Report",
        pageStyle: "print",
    });
        ...
        },
        {
            ...
            cellRenderer: (params) => (
                <Grid sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    {isUserRoleCompare?.includes("vbiometricvisitorsattendancereport") && (
                        <>
    ...
    return (
        <Box>
            <Headtitle title={"BIOMETRIC VISITORS ATTENDANCE REPORT"} />
            <PageHeading
                ...
                subsubpagename="Biometric Visitors Attendance Report"
            />
            {isUserRoleCompare?.includes("lbiometricvisitorsattendancereport") && (
                <Box sx={userStyle.selectcontainer}>

                    <>
                        <Typography sx={userStyle.importheadtext}>Biometric Visitors Attendance Report Filter</Typography>
                        <br />
                    ...
                    <Box sx={userStyle.container}>
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>
                                List Biometric Visitors Attendance Report
                            </Typography>
                        </Grid>
                        <Grid container spacing={2} style={userStyle.dataTablestyle}>
                            ...
                            >
                                <Box>
                                    {isUserRoleCompare?.includes("excelbiometricvisitorsattendancereport") && (
                                        <>
                                            <Button
                                                onClick={(e) => {
                                    ...
                                    {isUserRoleCompare?.includes("csvbiometricvisitorsattendancereport") && (
                                        <>
                                            <Button
                                                onClick={(e) => {
                                                    setIsFilterOpen(true);
                                    ...
                                    {isUserRoleCompare?.includes("printbiometricvisitorsattendancereport") && (
                                        <>
                                    ...
                                    {isUserRoleCompare?.includes("pdfbiometricvisitorsattendancereport") && (
                                        <>
                                            <Button
                                                sx={userStyle.buttongrp}
                                                onClick={() => {
                                    ...
                                    {isUserRoleCompare?.includes("imagebiometricvisitorsattendancereport") && (
                                        <Button
                                            sx={userStyle.buttongrp}
            ...
            <ExportData
                ...
                filename={"Biometric Visitors Attendance Report"}
...
export default BiometricVisitorsAttendanceReport;
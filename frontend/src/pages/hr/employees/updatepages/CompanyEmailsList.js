...
function CompanyEmailsList() {
  ...
  let exportColumnNames = ['Company', 'Branch', 'Unit', 'Department', 'Team', 'Emp Code', 'Name', 'Username', 'Email', 'Company Email'];
  let exportRowValues = ['company', 'branch', 'unit', 'department', 'team', 'empcode', 'companyname', 'username', 'email', 'companyemail'];

        ...
        try {
            ...
            let ans = subprojectscreate?.data?.filterallDatauser?.filter((item) =>
                accessbranch.some(
                    ...
                    item.longleaveabsentaprooveddate?.includes(data)) || item.checklistassigned)
            );
                ...
                <>
                    {isUserRoleCompare?.includes("llongabsentrestrictioncompletedlist") && (
                        <>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={8}>
                                        <Typography sx={userStyle.SubHeaderText}>
                                            Long Absent Restriction Completed Self List
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={4}>
                            ...
                            <br />
                            <LongabsentrestrictionCompletedManual isManualUser={isManualUser} />
                        </>
                    )}
                </>
            )}

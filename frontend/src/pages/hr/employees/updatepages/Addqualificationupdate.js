...
function AddQualificationupdate() {
  ...
  let exportColumnNames = ['EmpCode', 'Employee Name', 'Username'];
  let exportRowValues = ['empcode', 'companyname', 'username'];
  ...
  const handleSubmitAddtodo = (e) => {
    const errorstodo = {};
    e.preventDefault();
    const isDuplicate = addAddQuaTodo.some(
      (item) =>
        item.addQual === addQual &&
        item.addInst === addInst &&

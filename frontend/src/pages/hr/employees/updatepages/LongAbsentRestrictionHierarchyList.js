...
import UserDocumentUploadView from '../../UserDocumentUploadView';
...
function LongAbsentRestrictionHierarchyList() {
  ...
  const columnDataTable = [
    ...
    },
    {
      ...
      cellRenderer: (params) => (
        <Grid sx={{ display: 'flex' }}>
          {isUserRoleCompare?.includes('eteamlongabsentrestrictionlist') && (
            <>
                ...
                <>
                  {isAssigned ? (
                    ...
                    <LoadingButton
                      ...
                      style={{ margin: '4px' }}
                      onClick={() => {
                        fetchFilteredUsersStatus(params.data, "Third")
                ...
                <>
                  ...
                  <LoadingButton
                    ...
                    onClick={() => {
                      ...
                      fetchFilteredUsersStatus(params.data, "fourth")
  ...
  const getCodeNew = async (details) => {
    ...
    try {
      ...
      if (!searchItem) {
        await fetchFilteredUsersStatus(details, "first")
        ...
        await fetchFilteredUsersStatus(details, "second")
            ...
            <Grid container spacing={2}>
              <Grid item md={12} xs={12} sm={12}>
                <FormControl
                  ...
                  sx={{
                    display: 'flex',
                    justifyContent: 'space-between', // To push the content left and right
                    alignItems: 'center',
                    flexDirection: 'row',
                ...
                >
                  ...
                  <UserDocumentUploadView
                    queryParams={{
                      ...
                      employeename: getDetails?.companyname,
                    }}

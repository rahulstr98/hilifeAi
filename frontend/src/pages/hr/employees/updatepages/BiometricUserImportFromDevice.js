...
import {
    Box, Button, Modal, Checkbox, Dialog, DialogActions, Fade,
    Backdrop, DialogContent, FormControl, FormControlLabel, Grid, IconButton, InputAdornment, List, ListItem, ListItemText, MenuItem, OutlinedInput, Popover, Radio, RadioGroup, Select, TextField, Tooltip, Typography
} from '@mui/material';
...
function BiometricUserImportFromDevice() {
    ...
    const customValueRendererPairedDevice = (valuePairedDevices, _categoryname) => {
        return valuePairedDevices?.length
            ...
            : "Please Select Biometric Devices";
    };
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage
                ...
                .then((blob) => {
                    saveAs(blob, 'Biometric User Import From Device.png');
                })
                .catch((error) => {
    ...
    const rowData = async (id, name) => {
        ...
        try {
            ...
            console.log(res?.data, "biometricuserimportfromdevice")
    ...
    const sendRequest = async () => {
        ...
        try {
            ...
            const user = await axios.post(SERVICE.IMPORT_BIOMETRIC_USERS_FROM_DEVICE, {
                headers: {
                    Authorization: `Bearer ${auth.APIToken}`,
                },
    ...
    const handleprint = useReactToPrint({
        ...
        documentTitle: 'Biometric User Import From Device',
        pageStyle: 'print',
    });
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String('Biometric User Import From Device'),
    ...
    const columnDataTable = [
        ...
        //             {isUserRoleCompare?.includes('ebiometricuserimportfromdevice') && (
        //                 <Button
        ...
        //                 </Button>
        //             )}
        //             {isUserRoleCompare?.includes('dbiometricuserimportfromdevice') && (
        //                 <Button
        ...
        //                 </Button>
        //             )}
        //             {isUserRoleCompare?.includes('vbiometricuserimportfromdevice') && (
        //                 <Button
        //                     sx={userStyle.buttonedit}
        //                     onClick={() => {
        ...
        //                 </Button>
        //             )}
        //             {isUserRoleCompare?.includes('ibiometricuserimportfromdevice') && (
        //                 <Button
        //                     sx={userStyle.buttonedit}
        //                     onClick={() => {
    ...
    return (
        <Box>
            ...
            {/* ****** Header Content ****** */}
            <PageHeading title="Biometric User Import From Device" modulename="Human Resources" submodulename="HR" mainpagename="BX-Biometric Device" subpagename="Biometric User Import From Device" subsubpagename="" />
            {isUserRoleCompare?.includes('abiometricuserimportfromdevice') && (
                <>
                    <Box sx={userStyle.dialogbox}>
                        <>
                            <Grid container spacing={2}>
                                <Grid item xs={8}>
                                    <Typography sx={userStyle.importheadtext}>Add Biometric User Import From Device</Typography>
                                </Grid>
                            </Grid>
                            <br />
                            <Grid container spacing={2}>
            ...
            <br />
            {/* ****** Table Start ****** */}
            {/* {isUserRoleCompare?.includes('lbiometricuserimportfromdevice') && (
                <>
                    <Box sx={userStyle.container}>
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>Biometric User Import From Device List</Typography>
                        </Grid>
                        <br />
                        <Grid container spacing={2} style={userStyle.dataTablestyle}>
                            ...
                            <Grid item md={8} xs={12} sm={12} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                <Box>
                                    {isUserRoleCompare?.includes('excelbiometricuserimportfromdevice') && (
                                        <>
                                            <Button
                                                onClick={(e) => {
                                    ...
                                    {isUserRoleCompare?.includes('csvbiometricuserimportfromdevice') && (
                                        <>
                                            <Button
                                                onClick={(e) => {
                                                    setIsFilterOpen(true);
                                    ...
                                    {isUserRoleCompare?.includes('printbiometricuserimportfromdevice') && (
                                        <>
                                    ...
                                    {isUserRoleCompare?.includes('pdfbiometricuserimportfromdevice') && (
                                        <>
                                            <Button
                                                sx={userStyle.buttongrp}
                                                onClick={() => {
                                    ...
                                    {isUserRoleCompare?.includes('imagebiometricuserimportfromdevice') && (
                        ...
                        &ensp;
                        {isUserRoleCompare?.includes('bdbiometricuserimportfromdevice') && (
            ...
            <ExportData
                ...
                filename={'Biometric User Import From Device'}
            ...
            <Modal
                open={modal.open}
                onClose={() => setModal({ open: false, type: "", message: "" })}
                ...
                <Fade in={modal.open}>
                    ...
                    >
                        ...
                        {modal.type === "success" ? (
                            ...
                            <ErrorOutline sx={{ fontSize: 60, color: "red", mb: 2 }} />
                        )}
            ...
            {/* INFO */}
            <InfoPopup openInfo={openInfo} handleCloseinfo={handleCloseinfo} heading="Biometric User Import From Device Info" addedby={addedby} updateby={updateby} />
...
export default BiometricUserImportFromDevice;

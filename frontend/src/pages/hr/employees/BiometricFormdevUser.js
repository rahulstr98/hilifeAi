...
const BiometricFormdevUser = ({
  ...
  const { buttonStyles, allfloor, allTeam, allUsersData, allareagrouping } =
    useContext(UserRoleAccessContext);
  const [documentFiles, setdocumentFiles] = useState("");
  const [loading, setLoading] = useState(false);
  const [loadingMessage, setLoadingMessage] = useState(
    "Image is compressing...!",
  );
  ...
  const handleEmployeeDocuments = async (id, name) => {
    try {
      ...
      const profileImage = responsenew?.data?.semployeedocument?.profileimage
  ...
  const handleBiometricActionClick = () => {
    if (
      !employee?.devicetype ||
      employee?.devicetype === "Please Select Device Type"
    ) {
      ...
      (!employee?.devicecompany ||
        employee?.devicecompany === "Please Select Company")
    ) {
      ...
      employee?.devicetype === "Location" &&
      (!employee?.devicebranch ||
        employee?.devicebranch === "Please Select Branch")
    ) {
      ...
      employee?.devicetype === "Location" &&
      (!employee?.deviceunit || employee?.deviceunit === "Please Select Unit")
    ) {
      ...
      employee?.devicetype === "Location" &&
      (!employee?.devicefloor ||
        employee?.devicefloor === "Please Select Floor")
    ) {
      ...
      employee?.devicetype === "Location" &&
      (!employee?.devicearea || employee?.devicearea === "Please Select Area")
    ) {
      setPopupContentMalert("Please Select Device Area.!");
      setPopupSeverityMalert("warning");
      handleClickOpenPopupMalert();
    } else if (
      !employee?.biometricdevicename ||
      employee?.biometricdevicename === "Please Select Device"
    ) {
  ...
  const checkBiometricUserDuplicate = async (
    biometricdevicename,
    staffNameC,
  ) => {
    try {
  ...
  const fetchUsersAvailability = async (device, biometricdevicename) => {
    try {
      if (
        ...
        // });
        let boweeGlobal = await axios.post(
  ...
  const handleSubmitBioCheck = async (e) => {
    e.preventDefault();
    const duplicateUserCheck = await checkBiometricUserDuplicate(
      employee.biometricdevicename,
    ...
    if (
      ...
      !employee?.usertype ||
      employee?.usertype === "Please Select User Type"
    ) {
      ...
      (!employee?.usercompany ||
        employee?.usercompany === "Please Select Company")
    ) {
      ...
      employee?.usertype === "Existing" &&
      (!employee?.userbranch || employee?.userbranch === "Please Select Branch")
    ) {
      ...
      employee?.usertype === "Existing" &&
      (!employee?.userunit || employee?.userunit === "Please Select Unit")
    ) {
      ...
      employee?.usertype === "Existing" &&
      (!employee?.userteam || employee?.userteam === "Please Select Team")
    ) {
      ...
      employee?.usertype === "Existing" &&
      (!employee?.biometricname ||
        employee?.biometricname === "Please Select Biometric Name")
    ) {
      ...
      (!employee?.biometricname || employee?.biometricname === "")
    ) {
      ...
      !employee?.biometricrole ||
      employee?.biometricrole === "Please Select Role"
    ) {
      ...
      employee?.biometricrole === "Administrator" &&
      !documentFiles
    ) {
    ...
    <Grid container spacing={2}>
        ...
        <>
          <Grid item md={3} xs={12} sm={12}>
            <FormControl fullWidth size="small">
              ...
              <Selects
                ...
                value={{
                  label: employee.devicecompany,
                  value: employee.devicecompany,
                }}
                // isDisabled={BioOldUserCheck ? true : false}
                onChange={(e) => {
                  setEmployee({
                    ...employee,
                    devicecompany: e.value,
                    devicebranch: "Please Select Branch",
                    deviceunit: "Please Select Unit",
                    devicefloor: "Please Select Floor",
                    devicearea: "Please Select Area",
          ...
          <Grid item md={3} xs={12} sm={12}>
            <FormControl fullWidth size="small">
              ...
              <Selects
                options={accessbranch
                  ?.filter((data) => data?.company === employee?.devicecompany)
                  ?.map((data) => ({
                    label: data.branch,
                    value: data.branch,
                  }))
                ...
                value={{
                  label: employee.devicebranch,
                  value: employee.devicebranch,
                }}
                // isDisabled={BioOldUserCheck ? true : false}
                onChange={(e) => {
                  setEmployee({
                    ...employee,
                    devicebranch: e.value,
                    deviceunit: "Please Select Unit",
                    devicefloor: "Please Select Floor",
                    devicearea: "Please Select Area",
                    biometricdevicename: "Please Select Device",
          ...
          <Grid item md={3} xs={12} sm={12}>
            <FormControl fullWidth size="small">
              ...
              <Selects
                ...
                value={{
                  label: employee.deviceunit,
                  value: employee.deviceunit,
                }}
                // isDisabled={BioOldUserCheck ? true : false}
                onChange={(e) => {
                  setEmployee({
          ...
          <Grid item md={3} xs={12} sm={12}>
            <FormControl fullWidth size="small">
              ...
              <Selects
                options={allfloor
                  ?.filter((data) => data?.branch === employee?.devicebranch)
                  ?.map((data) => ({
                    label: data.name,
                    value: data.name,
                  }))
                ...
                value={{
                  label: employee.devicefloor,
                  value: employee.devicefloor,
                }}
                // isDisabled={BioOldUserCheck ? true : false}
                onChange={(e) => {
                  setEmployee({
          ...
          <Grid item md={3} xs={12} sm={12}>
            <FormControl fullWidth size="small">
              ...
              <Selects
                ...
                value={{
                  label: employee.devicearea,
                  value: employee.devicearea,
                }}
                onChange={(e) => {
                  setEmployee({
                    ...employee,
          ...
          <Grid item md={3} xs={12} sm={12}>
            <FormControl fullWidth size="small">
              ...
              <Selects
                options={BiometricDeviceOptions?.filter(
                  (data) =>
                    data?.company === employee.devicecompany &&
                    data?.branch === employee.devicebranch &&
                    data?.unit === employee.deviceunit &&
                    data?.floor === employee.devicefloor &&
                    data?.area === employee.devicearea,
                )}
                value={{
                  label: employee.biometricdevicename,
                  value: employee.biometricdevicename,
                }}
                // isDisabled={BioOldUserCheck ? true : false}
                onChange={(e) => {
          ...
          <Selects
            ...
            onChange={(e) => {
              setEmployee({
                ...
                usertype: e.value,
                biometricname:
                  e.value === "New User" ? "" : "Please Select Biometric Name",
                usercompany: "Please Select Company",
                userbranch: "Please Select Branch",
                userunit: "Please Select Unit",
                userteam: "Please Select Team",
        ...
        <>
          <Grid item md={3} xs={12} sm={12}>
            <FormControl fullWidth size="small">
              ...
              <Selects
                ...
                value={{
                  label: employee.usercompany,
                  value: employee.usercompany,
                }}
                // isDisabled={BioOldUserCheck ? true : false}
                onChange={(e) => {
                  setEmployee({
          ...
          <Grid item md={3} xs={12} sm={12}>
            <FormControl fullWidth size="small">
              ...
              <Selects
                options={accessbranch
                  ?.filter((data) => data?.company === employee?.usercompany)
                  ?.map((data) => ({
                    label: data.branch,
                    value: data.branch,
                  }))
                ...
                value={{
                  label: employee.userbranch,
                  value: employee.userbranch,
                }}
                // isDisabled={BioOldUserCheck ? true : false}
                onChange={(e) => {
                  setEmployee({
          ...
          <Grid item md={3} xs={12} sm={12}>
            <FormControl fullWidth size="small">
              ...
              <Selects
                ...
                value={{
                  label: employee.userteam,
                  value: employee.userteam,
                }}
                // isDisabled={BioOldUserCheck ? true : false}
                onChange={(e) => {
                  setEmployee({
          ...
          <Grid item md={2.8} xs={12} sm={12}>
            <FormControl fullWidth size="small">
              ...
              <OutlinedInput value={employee?.userid} readOnly />
            </FormControl>
          </Grid>
        </>
      )}
      ...
      <Grid item md={2.8} xs={12} sm={12}>
        <FormControl fullWidth size="small">
          ...
          {employee?.usertype === "Existing" ? (
            <OutlinedInput value={third} readOnly />
          ) : (
            <OutlinedInput
              value={third}
              onChange={(e) => {

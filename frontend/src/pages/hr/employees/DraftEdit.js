...
import HiConnectComponentCreate from './HiConnectComponentCreate.js';
...
import { generatePassword, validatePassword, attachFilesToObjects } from '../../../components/passwordGenerator';
...
function DraftEdit() {
  ...
  useEffect(() => {
    ...
    if (modevalue) {
      ...
      if (assignExperience.assignEndExpvalue === 'Yes') {
        ...
        differenceInMonthsexp = calculateMonthsBetweenDates(employee?.doj, assignExperience.assignEndExpDate);
        ...
        differenceInMonthsexp = calculateMonthsBetweenDates(employee?.doj, findDate);
        differenceInMonthsexp = differenceInMonthsexp < 1 ? 0 : differenceInMonthsexp;
      ...
      if (modevalue.endtar === 'Yes') {
        differenceInMonthstar = calculateMonthsBetweenDates(employee?.doj, assignExperience.assignEndExpvalue);
        ...
        differenceInMonthstar = calculateMonthsBetweenDates(employee?.doj, findDate);
        differenceInMonthstar = differenceInMonthstar < 1 ? 0 : differenceInMonthstar;
        if (assignExperience.assignExpMode === 'Add') {
          differenceInMonthstar += parseInt(assignExperience.assignExpvalue);
        } else if (assignExperience.assignExpMode === 'Minus') {
  ...
  const handleButtonClick = (e) => {
    ...
    if ((assignExperience?.assignExpMode === 'Add' || assignExperience?.assignExpMode === 'Minus' || assignExperience?.assignExpMode === 'Fix') && !assignExperience?.assignExpvalue && salaryOption !== 'Experience Based') {
  ...
  const rowData = async () => {
    try {
      ...
      setValueAttMode(res?.data?.sdraft?.attendancemode ? res?.data?.sdraft?.attendancemode.map((data) => data) : []);
      ...
      setPrimaryWorkStation(res?.data?.sdraft?.workstation[0] || 'Please Select Primary Work Station');
      ...
      const updatedData = assignPrimarySecondaryWorkstations([res?.data?.sdraft]);
      ...
      const employeeCount = Number(res?.data?.sdraft?.employeecount ?? 0) + Number(res?.data?.sdraft?.wfhcount ?? 0);
      setMaxSelections(employeeCount);
      var filteredWorks;
      if (res?.data?.sdraft?.unit === '' && res?.data?.sdraft?.floor === '') {
        filteredWorks = workStationOpt?.filter((u) => u.company === res?.data?.sdraft?.company && u.branch === res?.data?.sdraft?.branch);
      } else if (res?.data?.sdraft?.unit === '') {
        filteredWorks = workStationOpt?.filter((u) => u.company === res?.data?.sdraft?.company && u.branch === res?.data?.sdraft?.branch && u.floor === res?.data?.sdraft?.floor);
      } else if (res?.data?.sdraft?.floor === '') {
        filteredWorks = workStationOpt?.filter((u) => u.company === res?.data?.sdraft?.company && u.branch === res?.data?.sdraft?.branch && u.unit === res?.data?.sdraft?.unit);
      } else {
        filteredWorks = workStationOpt?.filter((u) => u.company === res?.data?.sdraft?.company && u.branch === res?.data?.sdraft?.branch && u.unit === res?.data?.sdraft?.unit && u.floor === res?.data?.sdraft?.floor);
      }
      ...
      let primaryWorkstationNew = res?.data?.sdraft?.workstation[0] || 'Please Select Primary Work Station';
      ...
      let secondaryWorkstation = Array.isArray(res?.data?.sdraft?.workstation)
        ? res?.data?.sdraft?.workstation
            ?.filter((item) => item !== res?.data?.sdraft?.workstation[0])
            .map((x) => ({
              ...x,
              label: x,
              value: x,
      ...
      setValueWorkStation(res?.data?.sdraft?.workstation?.filter((item) => item !== res?.data?.sdraft?.workstation[0]));
      //workstation end
  ...
  const { isUserRoleCompare, isUserRoleAccess, buttonStyles, allUsersData, workStationSystemName } = useContext(UserRoleAccessContext);
  ...
  const fetchbranchCodes = async (selectedBranch, selectedCompany) => {
    try {
      ...
      const branchCode = req?.data?.branch?.find((item) => item.name === selectedBranch && item.company === selectedCompany);
  ...
  const handleSetFiles = (apiFiles) => {
    const convertedFiles = apiFiles.map((file) => {
      const actualFile = base64ToFile(file.preview, file.name || 'document.png');

      return {
        ...file,
        file: actualFile, // actual File object for Multer/File Upload
      };
    });
  ...
  const fetchHandlerEdit = async () => {
    try {
      ...
      setSelectedAttMode(isThere);
      setValueAttMode(response?.data?.sdraft?.attendancemode ? response?.data?.sdraft?.attendancemode.map((data) => data) : []);
      ...
      fetchSuperVisorDropdowns(response?.data?.sdraft?.team, response?.data?.sdraft);
      setAccessible({
        company: response?.data?.sdraft?.accessiblecompany ? response?.data?.sdraft?.accessiblecompany : 'Please Select Company',
        branch: response?.data?.sdraft?.accessiblebranch ? response?.data?.sdraft?.accessiblebranch : 'Please Select Branch',
        unit: response?.data?.sdraft?.accessibleunit ? response?.data?.sdraft?.accessibleunit : 'Please Select Unit',
      ...
      if (response?.data?.sdraft?.assignExpLog?.lenth === 0) {
        ...
        setAssignExperience({
          ...assignExperience,
          assignExpMode: response?.data?.sdraft?.assignExpLog[0]?.expmode || 'Auto Increment',
          assignExpvalue: response?.data?.sdraft?.assignExpLog[0]?.expval || 0,
          assignEndExpDate: response?.data?.sdraft?.assignExpLog[0]?.endexpdate !== '' ? moment(response?.data?.sdraft?.assignExpLog[0]?.endexpdate).format('YYYY-MM-DD') : '',
          assignEndTarDate: response?.data?.sdraft?.assignExpLog[0]?.endtardate !== '' ? moment(response?.data?.sdraft?.assignExpLog[0]?.endtardate).format('YYYY-MM-DD') : '',
          assignEndTarvalue: response?.data?.sdraft?.assignExpLog[0]?.endtar,
          assignEndExpvalue: response?.data?.sdraft?.assignExpLog[0]?.endexp,
          updatedate: response?.data?.sdraft?.assignExpLog[0]?.updatedate !== '' ? moment(response?.data?.sdraft?.assignExpLog[0]?.updatedate).format('YYYY-MM-DD') : '',
        });
      }
      ...
      fetchEditareaNames(response?.data?.sdraft?.company, response?.data?.sdraft?.branch, response?.data?.sdraft?.floor);
      // handleSetFiles(response?.data?.sdraft?.files?.length > 0 ? response?.data?.sdraft?.files : []);
      ...
      let expLog = response?.data?.sdraft?.assignExpLog?.length > 0 ? response?.data?.sdraft?.assignExpLog[response?.data?.sdraft?.assignExpLog?.length - 1] : {};
      setSalarysetupForm({
      ...
      const edurawData = responsenew?.data?.semployeedocument?.eduTodo || [];
      const updatedEduData = await attachFilesToObjects(edurawData, SERVICE.EMPLOYEE_DOCUMENT_FILES);
      setEduTodo(updatedEduData);

      const eduAddData = responsenew?.data?.semployeedocument?.addAddQuaTodo || [];
      const updatedAddData = await attachFilesToObjects(eduAddData, SERVICE.EMPLOYEE_DOCUMENT_FILES);
      setAddQuaTodo(updatedAddData);

      const eduWorkData = responsenew?.data?.semployeedocument?.workhistTodo || [];
      const updatedWorkData = await attachFilesToObjects(eduWorkData, SERVICE.EMPLOYEE_DOCUMENT_FILES);
      setWorkhistTodo(updatedWorkData);
      ...
      if (responsenew?.data?.semployeedocument?.files?.length === 0) {
        ...
        let fileDatas = responsenew?.data?.semployeedocument?.files
        ...
        const eduFilesData = fileDatas || [];
        const updatedFilesData = await attachFilesToObjects(eduFilesData, SERVICE.EMPLOYEE_DOCUMENT_FILES);
      ...
      let branchCode = await fetchbranchCodes(response?.data?.sdraft?.branch, response?.data?.sdraft?.company);
      let newEmpCode = await EmployeeCodeAutoGenerate(response?.data?.sdraft?.company || '', response?.data?.sdraft?.branch || '', branchCode || '', response?.data?.sdraft?.doj || moment().format('YYYY-MM-DD'));
      ...
      setCreateHiConnect({
        createhiconnect: response?.data?.sdraft?.createhiconnect || false,
      ...
      if (response?.data?.sdraft?.department) {
        let deptsingle = await fetchDepartmentSingle(response?.data?.sdraft?.department);
  ...
  const SendDraftEdit = async () => {
    ...
    try {
      ...
      let employees_draft = await axios.put(`${SERVICE.DRAFT_SINGLE}/${id}`, {
        ...
        departmentlog: [
          {
            userid: String(employee?.wordcheck === false ? newval : employee?.empcode),
            logeditedby: [],
            updateddatetime: String(new Date(employee?.doj)),
            updatedusername: String(isUserRoleAccess.companyname),
            companyname: String(selectedCompany),
        ...
        processlog:
          loginNotAllot.process === 'Please Select Process' || loginNotAllot.time === '00:00'
            ? []
            : [
                {
                  logeditedby: [],
              ...
              <Grid container spacing={2}>
                ...
                <Grid item md={4} sm={12} xs={12}>
                  <FormControl size="small" fullWidth>
                    ...
                    <OutlinedInput id="component-outlined" type="text" placeholder="company name" value={companycaps} />
                  </FormControl>
                </Grid>
              </Grid>{' '}
              <br />

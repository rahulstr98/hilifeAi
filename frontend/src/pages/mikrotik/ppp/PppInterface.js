...
import PppInterfaceData from './PppInterfaceData';
...
function PppInterface() {
    ...
    const { dataInterface, loading, error } = PppInterfaceData(filterFinal?.url, filterFinal?.username, filterFinal?.password, interval, filterApplied);
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("Mikrotik PPP Interface"),
    ...
    const handleprint = useReactToPrint({
        ...
        documentTitle: "Mikrotik PPP Interface",
        pageStyle: "print",
    });
    ...
    return (
        <Box>
            <Headtitle title={"MIKROTIK PPP INTERFACE"} />
            {/* ****** Header Content ****** */}
            <PageHeading
                title="Mikrotik PPP Interface"
                modulename="Mikrotik"
                submodulename="PPP"
                mainpagename="PPP Interface"
                subpagename=""
                subsubpagename=""
            />
            <>
                {isUserRoleCompare?.includes("lpppinterface") && (
                    <Box sx={userStyle.selectcontainer}>
                        <>
                            <Grid container spacing={2}>
                                <Grid item xs={8}>
                                    <Typography sx={userStyle.importheadtext}>
                                        Filter Mikrotik PPP Interface
                                    </Typography>
                                </Grid>
                            </Grid>
                            <br />
                    ...
                    {loading ? (
                        ...
                        <Box sx={userStyle.container}>
                            ...
                            <Grid container spacing={2} style={userStyle.dataTablestyle}>
                                ...
                                >
                                    <Box>
                                        {isUserRoleCompare?.includes("excelpppinterface") && (
                                            <>
                                                <Button
                                                    onClick={(e) => {
                                        ...
                                        {isUserRoleCompare?.includes("csvpppinterface") && (
                                            <>
                                                <Button
                                                    onClick={(e) => {
                                                        setIsFilterOpen(true);
                                        ...
                                        {isUserRoleCompare?.includes("printpppinterface") && (
                                            <>
                                        ...
                                        {isUserRoleCompare?.includes("pdfpppinterface") && (
                                            <>
                                                <Button
                                                    sx={userStyle.buttongrp}
                                                    onClick={() => {
                                        ...
                                        {isUserRoleCompare?.includes("imagepppinterface") && (
                                            <Button
                                                sx={userStyle.buttongrp}
            ...
            <ExportData
                ...
                itemsTwo={items ?? []}
                filename={"Mikrotik PPP Interface"}

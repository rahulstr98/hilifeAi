...
function Logs() {
    ...
    const handleFilter = (e) => {
        ...
        if (filterDatas.company === "Please Select Company") {
            ...
            fetchMikroTikLogs(filterDatas?.url,
                filterDatas?.username,
                filterDatas?.password,
                filterDatas?.fromdate,
                // filterDatas?.fromtime,
                `${time.hours}:${time.minutes}:${time.seconds}` , 
                filterDatas?.todate,
                // filterDatas?.totime,
                 `${totime.hours}:${totime.minutes}:${totime.seconds}`
            )
    ...
    const deleteTeam = async () => {
        ...
        try {
            ...
            await fetchMikroTikLogs(filterFinal?.url,
    ...
    //get all Asset Variant name.
    const fetchMikroTikLogs = async (url,
        username,
        password, fromdate, fromtime, todate, totime) => {
        setPageName(!pageName);
        try {
            setLoader(true);
            let response = await axios.post(SERVICE.GET_MIKROTIK_LOGS, {
                url, username, password, fromdate, fromtime, todate, totime
            }, {
                headers: {
                    Authorization: `Bearer ${auth.APIToken}`,
                },
...

        {
            ...
            renderCell: (params) => (
                <Grid sx={{ display: "flex" }}>
                    ...
                    {isUserRoleCompare?.includes("vlogs") && (
                        <Button
    ...
    return (
        <Box>
            ...
            />
            <>
                {isUserRoleCompare?.includes("llogs") && (
                    <Box sx={userStyle.selectcontainer}>
                        <>
                            <Grid container spacing={2}>
                                <Grid item xs={8}>
                                    <Typography sx={userStyle.importheadtext}>
                                        Filter Mikrotik Logs
                                    </Typography>
                                </Grid>
                            </Grid>
                            <br />
                                ...
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <OutlinedInput
                                            id="from-date"
                                            type="date"
                                            value={filterDatas.fromdate}
                                            inputProps={{
                                                min: oneMonthBefore, // Set the minimum date to today
                                                max: today, // Set the minimum date to today
                                            }}
                                            onChange={(e) => {
                                                setFilterDatas({
                                                    ...filterDatas,
                                    ...
                                    <FormControl fullWidth size="small">
                                        ...
                                        <Box display="flex" gap={2} alignItems="center" mt={0}>
                                            <FormControl variant="outlined" sx={{ minWidth: 80 }}>
                                                ...
                                                >
                                                    {generateOptions(24).map((option, index) => (
                                                        <MenuItem key={index} value={option?.props.value}>
                                                            {option?.props.value}
                                                        </MenuItem>
                                                    ))}
                                                </Select>
                                            ...
                                            <FormControl variant="outlined" sx={{ minWidth: 80 }}>
                                                ...
                                                >
                                                    {generateOptions(59).map((option, index) => (
                                                        <MenuItem key={index} value={option?.props.value}>
                                                            {option?.props.value}
                                                        </MenuItem>
                                                    ))}
                                ...
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <OutlinedInput
                                            ...
                                            inputProps={{
                                                min: filterDatas.fromdate,
                                                max: today
                                            }}
                                            disabled={!filterDatas.fromdate}
                                        />
                                    </FormControl>
                                </Grid>
                                <Grid item md={4} xs={12} sm={12}>
                                        ...
                                        <Box display="flex" gap={2} alignItems="center" mt={0}>
                                            <FormControl variant="outlined" sx={{ minWidth: 80 }}>
                                                ...
                                                <Select
                                                    ...
                                                    name="hours"
                                                    value={totime.hours}
                                                    onChange={(e) => handletoChange(e.target.value, 'hours')}
                                                >
                                                    {generateOptions(24).map((option, index) => (
                                                        <MenuItem key={index} value={option?.props.value}>
                                                            {option?.props.value}
                                            ...
                                            <FormControl variant="outlined" sx={{ minWidth: 80 }}>
                                                ...
                                                <Select
                                                    ...
                                                    onChange={(e) => handletoChange(e.target.value, 'minutes')}
                                                >
                                                    {generateOptions(59).map((option, index) => (
                                                        <MenuItem key={index} value={option?.props.value}>
                                                            {option?.props.value}
                                            ...
                                            <FormControl variant="outlined" sx={{ minWidth: 80 }}>
                                                ...
                                                <Select
                                                    ...
                                                    onChange={(e) => handletoChange(e.target.value, 'seconds')}
                                                >
                                                    {generateOptions(59).map((option, index) => (
                                                        <MenuItem key={index} value={option?.props.value}>
                                                            {option?.props.value}
                    ...
                    {loader ? (
                        ...
                        <Box sx={userStyle.container}>
                            ...
                            <Grid container spacing={2} style={userStyle.dataTablestyle}>
                                ...
                                >
                                    <Box>
                                        {isUserRoleCompare?.includes("excellogs") && (
                                            <>
                                                <Button
                                                    onClick={(e) => {
                                        ...
                                        {isUserRoleCompare?.includes("csvlogs") && (
                                            <>
                                                <Button
                                                    onClick={(e) => {
                                                        setIsFilterOpen(true);
                                        ...
                                        {isUserRoleCompare?.includes("printlogs") && (
                                            <>
                                        ...
                                        {isUserRoleCompare?.includes("pdflogs") && (
                                            <>
                                                <Button
                                                    sx={userStyle.buttongrp}
                                                    onClick={() => {
                                        ...
                                        {isUserRoleCompare?.includes("imagelogs") && (
                                            <Button
                                                sx={userStyle.buttongrp}
                        ...
                        <Grid container spacing={2}>
                            <Grid item md={12} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    ...
                                    <Typography>{singleRow.message}</Typography>
                                </FormControl>
                            </Grid>
                            <Grid item md={6} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    <Typography variant="h6">Time</Typography>
                                    <Typography>{singleRow.time}</Typography>
                                </FormControl>
                            </Grid>
                            <Grid item md={6} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    <Typography variant="h6">Topics</Typography>
                                    <Typography>{singleRow.topics}</Typography>
                                </FormControl>
                            </Grid>

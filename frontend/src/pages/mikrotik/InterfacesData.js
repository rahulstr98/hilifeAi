...
const InterfacesData = (url, username, password, interval = 1000, filterApplied) => { // Default interval set to 5 seconds
    ...
    const fetchData = async () => {
        try {
            ...
            let datas =
                response?.data?.allmikrotikinterface// Replace with your endpoint

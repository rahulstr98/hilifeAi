...
function IpPools() {
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("Mikrotik IP Pools"),
    ...
    const handleCaptureImage = () => {
        if (gridRef.current) {
            html2canvas(gridRef.current).then((canvas) => {
                canvas.toBlob((blob) => {
                    saveAs(blob, "Mikrotik IP Pools.png");
                });
            });
        }
    };
    ...
    const handleprint = useReactToPrint({
        ...
        documentTitle: "Mikrotik IP Pools",
        pageStyle: "print",
    });
...

        {
            ...
            renderCell: (params) => (
                <Grid sx={{ display: "flex" }}>
                    {/* {isUserRoleCompare?.includes("eippools") && (
                        <>
                            <Button
                    ...
                    {isUserRoleCompare?.includes("dippools") && (
                        <>
                            <Button
                    ...
                    {isUserRoleCompare?.includes("vippools") && (
                        <Button
                            sx={userStyle.buttonedit}
                            onClick={() => {
                    ...
                    {/* {isUserRoleCompare?.includes("iippools") && (params?.row?.addedby?.length > 0 || params?.row?.updatedby?.length > 0) && (
                        <Button
                            size="small"
    ...
    return (
        <Box>
            <Headtitle title={"MIKROTIK IP POOLS"} />
            {/* ****** Header Content ****** */}
            <PageHeading
                title="Mikrotik IP Pools"
                modulename="Mikrotik"
                submodulename="IP"
                mainpagename="Pool"
                subpagename="IP Pools"
                subsubpagename=""
            />
            <>
                {isUserRoleCompare?.includes("lippools") && (
                    <Box sx={userStyle.selectcontainer}>
                        <>
                            <Grid container spacing={2}>
                                <Grid item xs={8}>
                                    <Typography sx={userStyle.importheadtext}>
                                        Filter Mikrotik IP Pools
                                    </Typography>
                                </Grid>
                            </Grid>
                            <br />
                    ...
                    {loader ? (
                        ...
                        <Box sx={userStyle.container}>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12}>
                                    <Typography sx={userStyle.importheadtext}>
                                        List Mikrotik IP Pools
                                    </Typography>
                                </Grid>
                                {/* <Grid item xs={2}>
                                    {isUserRoleCompare?.includes("aippools") && filterApplied && (
                                        <>
                            ...
                            <Grid container spacing={2} style={userStyle.dataTablestyle}>
                                ...
                                >
                                    <Box>
                                        {isUserRoleCompare?.includes("excelippools") && (
                                            <>
                                                <Button
                                                    onClick={(e) => {
                                        ...
                                        {isUserRoleCompare?.includes("csvippools") && (
                                            <>
                                                <Button
                                                    onClick={(e) => {
                                                        setIsFilterOpen(true);
                                        ...
                                        {isUserRoleCompare?.includes("printippools") && (
                                            <>
                                        ...
                                        {isUserRoleCompare?.includes("pdfippools") && (
                                            <>
                                                <Button
                                                    sx={userStyle.buttongrp}
                                                    onClick={() => {
                                        ...
                                        {isUserRoleCompare?.includes("imageippools") && (
                                            <Button
                                                sx={userStyle.buttongrp}

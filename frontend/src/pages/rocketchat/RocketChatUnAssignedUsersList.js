...
function RocketChatUnAssignedUsersList() {
    ...
    const getapi = async () => {
        let userchecks = axios.post(`${SERVICE.CREATE_USERCHECKS}`, {
            ...
            pagename: String("ConnecTTS UnAssigned Users List"),
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "ConnecTTSUnAssignedUsersList.png");
                })
                .catch((error) => {
    ...
    const handleprint = useReactToPrint({
        ...
        documentTitle: "ConnecTTS UnAssigned Users List",
        pageStyle: "print",
    });
...

        {
            ...
            cellRenderer: (params) => (
                <Grid sx={{ display: "flex" }}>
                    ...
                    {isUserRoleCompare?.includes("vconnecttsunassigneduserslist") && (
                        <Button
                    ...
                    {isUserRoleCompare?.includes("aconnecttsunassigneduserslist") && (
                        <Tooltip title={`Create Account for ${params.data.companyname} in ConnecTTS`} arrow>
                            <Button
                                sx={{
                                ...
                                onClick={() => {
                                    setAddDetails({
                                        ...
                                        rocketchatname: params?.data?.companyname,
                                        rocketchatusername: params?.data?.username?.toLowerCase(),
                                        password: params?.data?.originalpassword,
                                        showpassword: false,
                                        rocketchatemail: params?.data?.companyemailarray[0] || "",
                                        rocketchatemailoptions: params?.data?.companyemailarray?.map(data => ({
                                            label: data,
                                            value: data,
                                        })),
                                        rocketchatroles: [{ label: "user", value: "user" }],
                                    });
                                    handleClickOpenAdd() // Function to handle syncing accounts
                                }}
                            >
                                <AddIcon sx={{ marginRight: "5px", fontSize: "1rem" }} /> {/* Sync icon */}
                                Create Account
                            </Button>
                        </Tooltip>
                    )}
    ...
    const rowDataTable = filteredData?.map((item, index) => {
        return {
            ...
            companyemailarray: item?.companyemailarray,
        };
    });
    ...
    const handleSubmit = (e) => {
        ...
        if (addDetails.rocketchatname?.trim() === "") {
    ...
    const fetchRocketChatUsers = async () => {
        ...
        try {
            let response = await axios.post(
                SERVICE.ROCKETCHAT_UNASSIGNED_USERS,
                {
                    headers: {
                        Authorization: `Bearer ${auth.APIToken}`,
                    },
            ...
            const itemsWithSerialNumber = response?.data?.unmatchedLocalUsers.map((item, index) => ({
                ...
                originalpassword: item?.originalpassword || "",
                companyemail: item?.companyemail,
                companyemailarray: item?.companyemail?.split(",") || [],
                workmode: item?.workmode === "Internship" ? "Internship" : "Employee",
    ...
    return (
        <Box>
            <NotificationContainer />
            <Headtitle title={"CONNECTTS UNASSIGNED USERS LIST"} />
            {/* ****** Header Content ****** */}
            <PageHeading
                title="ConnecTTS UnAssigned Users List"
                modulename="connecTTS"
                submodulename="ConnecTTS UnAssigned Users List"
                mainpagename=""
                subpagename=""
                subsubpagename=""
            />
            {isUserRoleCompare?.includes("lconnecttsunassigneduserslist") && (
                <>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12}>
                                        <Typography sx={userStyle.SubHeaderText}>
                                            ConnecTTS UnAssigned Users List
                                        </Typography>
                                    </Grid>
                                </Grid>
                                <br />
                                    ...
                                    >
                                        <Box>
                                            {isUserRoleCompare?.includes(
                                                "excelconnecttsunassigneduserslist"
                                            ) && (
                                                    <>
                                                        <Button
                                                            onClick={(e) => {
                                            ...
                                            {isUserRoleCompare?.includes(
                                                "csvconnecttsunassigneduserslist"
                                            ) && (
                                                    <>
                                                        <Button
                                                            onClick={(e) => {
                                            ...
                                            {isUserRoleCompare?.includes(
                                                "printconnecttsunassigneduserslist"
                                            ) && (
                                                    <>
                                                        <Button
                                                            sx={userStyle.buttongrp}
                                            ...
                                            {isUserRoleCompare?.includes(
                                                "pdfconnecttsunassigneduserslist"
                                            ) && (
                                                    <>
                                                        <Button
                                                            sx={userStyle.buttongrp}
                                            ...
                                            {isUserRoleCompare?.includes(
                                                "imageconnecttsunassigneduserslist"
                                            ) && (
                                                    <Button
                                                        sx={userStyle.buttongrp}
            ...
            <ExportData
                ...
                itemsTwo={employees ?? []}
                filename={"ConnecTTSUnAssignedUsersList"}
                ...
                <Box sx={{ padding: "20px 50px" }}>
                    <>
                        <Typography sx={userStyle.HeaderText}>
                            {" "}
                            View ConnecTTS UnAssigned User Details
                        </Typography>
                        <br />
                        <Grid container spacing={2}>
                            ...
                            <Grid item md={4} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    ...
                                    <Typography sx={{
                                        ...
                                        whiteSpace: "pre-wrap",
                                    }}>{viewDetails.companyemail}</Typography>
                                </FormControl>
                            </Grid>
                            <Grid item md={4} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                            ...
                            <Grid item md={4} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    ...
                                    <Typography>{viewDetails.originalpassword}</Typography>
                                </FormControl>
                            </Grid>
                        ...
                        <>
                            ...
                            <Grid container spacing={2}>
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        <Typography variant="h6">Company</Typography>
                                        <Typography>{addDetails?.company}</Typography>
                                    </FormControl>
                                </Grid>
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        <Typography variant="h6">Branch</Typography>
                                        <Typography>{addDetails?.branch}</Typography>
                                    </FormControl>
                                </Grid>
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        <Typography variant="h6">Unit</Typography>
                                        <Typography>{addDetails?.unit}</Typography>
                                    </FormControl>
                                </Grid>
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        <Typography variant="h6">Team</Typography>
                                        <Typography>{addDetails?.team}</Typography>
                                    </FormControl>
                                </Grid>
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        <Typography variant="h6">Department</Typography>
                                        <Typography>{addDetails?.department}</Typography>
                                    </FormControl>
                                </Grid>
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        <Typography variant="h6">Designation</Typography>
                                        <Typography>{addDetails?.designation}</Typography>
                                    </FormControl>
                                </Grid>
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        <Typography variant="h6">Work Mode</Typography>
                                        <Typography>{addDetails?.workmode}</Typography>
                                    </FormControl>
                                </Grid>
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                ...
                                <Grid item md={4} xs={12} sm={12}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <Selects
                                            options={addDetails?.rocketchatemailoptions?.filter((item, index, self) => {
                                                return (
                                                    self.findIndex(
                                                        (i) =>
                                                            i.label === item.label &&
                                            ...
                                            styles={colourStyles}
                                            value={{
                                                label: addDetails.rocketchatemail ?? "Please Select Email",
                                                value: addDetails.rocketchatemail ?? "Please Select Email",
                                            }}
                                            onChange={(e) => {
                                                setAddDetails((prev) => ({
                                                    ...prev,
                                                    rocketchatemail: e.value,
                                                }));
...
export default RocketChatUnAssignedUsersList;
...
function LockedUsersList() {
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading title="Hierarchy Locked Users List" modulename="LDAP" submodulename="Hierarchy Locked Users List" mainpagename="" subpagename="" subsubpagename="" />
          ...
          {isUserRoleCompare?.includes('lhierarchylockeduserslist') && (
            <>
              <Box sx={userStyle.container}>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={10}>
                    <Typography sx={userStyle.SubHeaderText}>Hierarchy Locked Users List</Typography>
                  </Grid>
                  <Grid item xs={2}>
                    {isUserRoleCompare?.includes('ahierarchylockeduserslist') && (
                      <>

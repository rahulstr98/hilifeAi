...
function DomainUsersList() {
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading title="Hierarchy Domain Users List" modulename="LDAP" submodulename="Hierarchy Domain Users List" mainpagename="" subpagename="" subsubpagename="" />
          ...
          {isUserRoleCompare?.includes('lhierarchydomainuserslist') && (
            <>
              <Box sx={userStyle.container}>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={10}>
                    <Typography sx={userStyle.SubHeaderText}>Hierarchy Domain Users List</Typography>
                  </Grid>
                  <Grid item xs={2}>
                    {isUserRoleCompare?.includes('ahierarchydomainuserslist') && (
                      <>

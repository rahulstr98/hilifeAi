...
function TaskForUserCompleted({ com }) {
  ...
  let exportColumnNames = ['Task Status', 'Task Date', 'Priority', 'User Name', 'Completed By User', 'Task Time', 'Task Details', 'Frequency', 'Schedule', 'Task', 'Sub Task', 'Duration', 'Required', 'Break Up'];
  let exportRowValues = ['taskstatus', 'taskassigneddate', 'priority', 'username', 'completedbyuser', 'tasktime', 'taskdetails', 'frequency', 'schedule', 'category', 'subcategory', 'duration', 'required', 'breakup'];
  useEffect(() => {
    getapi();
  }, []);
  ...
  return (
    <Box>
      ...
      {/* ****** Header Content ****** */}
      <PageHeading title="Task User Panel- Completed Tasks" modulename="Task" submodulename="Completed Task" mainpagename="" subpagename="" subsubpagename="" />
            ...
            {isUserRoleCompare?.includes('lcompletedtask') && (
              <>
                <Typography sx={userStyle.SubHeaderText}>
                  User Task Panel - <b style={{ backgroundColor: 'green', color: 'white' }}>Completed Tasks</b>
                </Typography>
                {/* ******************************************************EXPORT Buttons****************************************************** */}

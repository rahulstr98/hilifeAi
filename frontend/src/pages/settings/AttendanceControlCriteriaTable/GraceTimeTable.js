...
const GraceTimeTable = ({ taskcategorys, setDeleteIndex, handleClickOpen }) => {
    ...
    const columnDataTable = [
        ...
        { field: "employeegracetime", headerName: "Grace Time", flex: 0, width: 150, hide: !columnVisibility.employeegracetime, headerClassName: "bold-header" },
            ...
            renderCell: (params) => (
                <Grid sx={{ display: 'flex', }}>
                    ...
                    <Button sx={userStyle.buttondelete} onClick={(e) => {
                        handleClickOpen(params.row.serialNumberdel);
                        setDeleteIndex(params.row.serialNumberdel)
    ...
    const rowDataTable = filteredData.map((item, index) => {
        return {
            ...
            employeegracetime: item.employeegracetime,
        }
    });
                ...
                <>
                    <Box >
                        ...
                        <Grid item md={12} xs={12} sm={12}>
                            <Typography sx={userStyle.importheadtext}><b>Grace Time List</b></Typography>
                        </Grid>

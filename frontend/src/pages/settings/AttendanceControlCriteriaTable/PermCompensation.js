...
const PermCompensationTable = ({ taskcategorys, setDeleteIndexPermCompensation, handleClickOpenPermCompensation }) => {
    ...
    const initialColumnVisibility = {
        ...
        team: true,
        employeename: true,
        enablepermcompensation: true,
        // permissionperdayduration: true,
        // permissionpermonthduration: true,
        actions: true,
    };
    ...
    const addSerialNumber = (data) => {
        const allData = data?.map((items, index) => ({
            ...
            enablepermcompensation: items.enablepermcompensation === true ? 'Yes' : 'No',
        }));
        setItems(allData);
    }
    ...
    const columnDataTable = [
        ...
        { field: "team", headerName: "Team", flex: 0, width: 180, hide: !columnVisibility.team, headerClassName: "bold-header" },
        ...
        { field: "enablepermcompensation", headerName: "Enable Permission Compensation", flex: 0, width: 250, hide: !columnVisibility.enablepermcompensation, headerClassName: "bold-header" },
        // { field: "permissionperdayduration", headerName: "Per Day(HRS:MIN)", flex: 0, width: 150, hide: !columnVisibility.permissionperdayduration, headerClassName: "bold-header" },
        // { field: "permissionpermonthduration", headerName: "Per Month Count", flex: 0, width: 150, hide: !columnVisibility.permissionpermonthduration, headerClassName: "bold-header" },
        {
            field: "actions",
            headerName: "Action",
            flex: 0,
            ...
            renderCell: (params) => (
                <Grid sx={{ display: 'flex', }}>
                    ...
                    <Button sx={userStyle.buttondelete} onClick={(e) => {
                        handleClickOpenPermCompensation(params.row.serialNumberdel);
                        setDeleteIndexPermCompensation(params.row.serialNumberdel)
    ...
    const rowDataTable = filteredData.map((item, index) => {
        return {
            ...
            enablepermcompensation: item.enablepermcompensation,
            // permissionperdayduration: item.permissionperdayduration,
            // permissionpermonthduration: item.permissionpermonthduration,
        }
    });
                ...
                <>
                    <Box >
                        ...
                        <Grid item md={12} xs={12} sm={12}>
                            <Typography sx={userStyle.importheadtext}><b>Permission Compensation List</b></Typography>
                        </Grid>
...
export default PermCompensationTable;
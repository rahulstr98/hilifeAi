...
const WeekOffTable = ({ taskcategorys, setDeleteIndexWeekoff, handleClickOpenWeekOff }) => {
    ...
    const columnDataTable = [
        ...
        { field: "enableweekoff", headerName: "Enable Week Off", flex: 0, width: 150, hide: !columnVisibility.enableweekoff, headerClassName: "bold-header" },
        { field: "enableholiday", headerName: "Enable Holiday", flex: 0, width: 150, hide: !columnVisibility.enableholiday, headerClassName: "bold-header" },
                ...
                <>
                    <Box >
                        ...
                        <Grid item md={12} xs={12} sm={12}>
                            <Typography sx={userStyle.importheadtext}><b>Weekoff/Holiday List</b></Typography>
                        </Grid>

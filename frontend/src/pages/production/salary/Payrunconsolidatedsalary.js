            ...
            .then((results) => {
              ...
              function processEmployeeItem(item, index, data) {
                try {
                  ...
                  console.log(finalresult, 'finalresult', index);
                  ...
                  // console.log(
                  //   dayPointsUser,
                  //   dayPointsUser.filter((data) => data.name === 'ABI.GNANAMOORTHY'),
                  //   'dayPointsUser'
                  // );
                  ...
                  let calcNetSalaryValCalc = Number(lopBasicValCal) + Number(lopHRAValCal) + Number(lopConveyValCal) + Number(lopMedicalValCal) + Number(lopProductionAllowance) + Number(lopOtherValCal);
                  ...
                  let paySlipLopCalval =
                    grossValue === 0 || totalNoOfDaysCalcVal === 0 || totalpaiddaycalVal === 0 ? 0 : totalshiftCalcVal - Math.round((totalshiftCalcVal * finalNetSalaryValcCalc) / grossValue) < 0 ? 0 : totalshiftCalcVal - Math.round((totalshiftCalcVal * finalNetSalaryValcCalc) / grossValue);
                  ...
                  let finalLeaveDeductionValCalc =
                    ...
                    grossValue === 0 || totalshiftCalcVal === 0 || totalNoOfDaysCalcVal === 0 || totalpaiddaycalVal === 0
                      ? 0

...
function MismatchStatusTemp() {
          ...
          for (let item of arrayDates) {
            try {
              let resNew = await axios.post(
                SERVICE.PRODUCTION_MISMATCH_STATUS_DATEFILTER_TEMP,
                {
  ...
  return (
    <Box>
      <Headtitle title={"Unmatch Status Temp"} />
      {/* ****** Header Content ****** */}
      <PageHeading title=" Unmatch Status Temp" modulename="Production" submodulename="Upload" mainpagename="Original" subpagename="Production Upload List" subsubpagename="" />

      <br />
      {/* ****** Table Start ****** */}
      {isUserRoleCompare?.includes("lmismatchstatustemp") && (
        <>
          ...
          <Box sx={userStyle.container}>
            <Grid container>
              <Grid item md={8} sm={8} xs={12}>
                <Typography sx={userStyle.importheadtext}>Unmatch Status Temp</Typography>
              </Grid>
            ...
            <Grid container style={userStyle.dataTablestyle}>
              ...
              <Grid item md={8} xs={12} sm={12} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                <Box>
                  {isUserRoleCompare?.includes("excelmismatchstatustemp") && (
                    // <>
                    //   <ExportXL
                  ...
                  {isUserRoleCompare?.includes("csvmismatchstatustemp") && (
                    // <>
                    //   <ExportCSV
                    //     csvData={filteredData?.map((t, index) => ({
                    //       Sno: index + 1,
                  ...
                  {isUserRoleCompare?.includes("printmismatchstatustemp") && (
                    <>
                  ...
                  {isUserRoleCompare?.includes("pdfmismatchstatustemp") && (
                    // <>
                  ...
                  {isUserRoleCompare?.includes("imagemismatchstatustemp") && (
...
export default MismatchStatusTemp;
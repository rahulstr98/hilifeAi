...
function TempOverallReport() {
      ...
      while (hasMoreData) {
        try {
          if (batchNumber === 0) {
            ...
            apiUrl = SERVICE.PRODUCTION_TEMP_FILTER;
          }
  ...
  const fetchBatch = async (batchNum) => {
   ...
   let totalBatchNumber = Math.ceil(fetchedUsers.length / 30);
    ...
    const apiUrl = SERVICE.PRODUCTION_TEMP_FILTER;
  ...
  const downloadPdf = () => {
    ...
    doc.save('Temp Overall Report.pdf');
  };

  // Excel
  const fileName = 'Temp Overall Report';

  //print...
  const componentRef = useRef();
  const handleprint = useReactToPrint({
    content: () => componentRef.current,
    documentTitle: 'Temp Overall Report',
    pageStyle: 'print',
  });
  ...
  return (
    <Box>
      <Headtitle title={'Temp Overall Report'} />
      {/* ****** Header Content ****** */}
      <Typography sx={userStyle.HeaderText}>Temp Overall Report</Typography>
      ...
      <Box sx={userStyle.dialogbox}>
        <>
          ...
          {isUserRoleCompare?.includes("loveralltempreport") && ( 
      ...
      <Box sx={userStyle.container}>
        {/* ******************************************************EXPORT Buttons****************************************************** */}
        <Grid item xs={8}>
          <Typography sx={userStyle.importheadtext}>Temp Overall Report</Typography>
        </Grid>
        <br />
        <Grid container spacing={2} style={userStyle.dataTablestyle}>
          ...
          <Grid item md={8} xs={12} sm={12} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <Box>
              {isUserRoleCompare?.includes("exceloveralltempreport") && ( 
              ...
              <>
                ...
                >
                  ...
                  &ensp;Export to Excel&ensp;
                            ...
                            {isUserRoleCompare?.includes("csvoveralltempreport") && ( 
              ...
              <>
                ...
                >
                  ...
                  &ensp;Export to CSV&ensp;
                            ...
                            {isUserRoleCompare?.includes("printoveralltempreport") && ( 
              <>
                <Button sx={userStyle.buttongrp} onClick={handleprint}>
                  ...
                  &ensp;Print&ensp;
                            ...
                            {isUserRoleCompare?.includes("pdfoveralltempreport") && (  
              ...
              <>
                ...
                >
                  ...
                  &ensp;Export to PDF&ensp;
                            ...
                            {isUserRoleCompare?.includes("imageoveralltempreport") && ( 

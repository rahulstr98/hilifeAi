...
function SheetName() {
    ...
    const handleSubmit = (e) => {
        ...
        const isNameMatch = categoryDateChangeData.some(item =>
            item.mode?.toLowerCase() === sheetname.mode?.toLowerCase() &&
            item.name?.toLowerCase() === sheetname.name?.toLowerCase()
        );
        if (sheetname.name === "") {
    ...
    const editSubmit = async (e) => {
        e.preventDefault();
        const isNameMatch = sheetNameEditDup.some(item =>
            item.mode === sheetNameEdit.mode &&
            item.name === sheetNameEdit.name 
        );
    ...
    const fetchEmployee = async () => {
        ...
        try {
            ...
            setSheetnameOverall(res_employee?.data?.sheetname?.map((item, index) => ({
                ...item,

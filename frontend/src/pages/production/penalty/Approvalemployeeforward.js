...
function ApprovalEmployeeForward() {
    ...
    let exportColumnNamestwo = ['Branch','Unit','Team','Name','Emp Code','Date','Ventor Name','Process','Total Field','Auto Error','Manual Error','Not Validate','Valid Error','Waiver%',
        'Emp Waiver','Net Error','per%','Percentage','Amount','Request Reason','Forward Reason','Mode','History','Month History','Approved','Reject','Recheck'];
    let exportRowValuestwo = ['branch','unit','team','name','empcode','date','ventorname','process','totalfield','autoerror','manualerror','notvalidate','validerror','waiver',
        'empwaiver','neterror','per','percentage','amount','requestreason','forwardreason','mode','history','monthhistory','approved','reject','recheck' ];
    ...
    const [approvalEmployeetwos, setApprovalEmployeetwos] = useState([]);
    ...
    const handleCaptureImage = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "Employee Waiver Request.png");
                })
                .catch((error) => {
    ...
    const handleCaptureImagetwo = () => {
        if (gridRefTableImg.current) {
            domtoimage.toBlob(gridRefTableImg.current)
                .then((blob) => {
                    saveAs(blob, "Recheck Forward.png");
                })
                .catch((error) => {
                    console.error("dom-to-image error: ", error);
                });
    ...
    const sendRequest = async () => {
        ...
        try {
            let grpcreate = await axios.post(SERVICE.GROUP_CREATE, {
                ...
                name: String(approvalEmployee.name),
                addedby: [
                    {
            ...
            setApprovalEmployee(grpcreate.data);
            await fetchAllClient();
            setApprovalEmployee({ name: "" });
    ...
    const getCode = async (e, name) => {
        ...
        try {
            ...
            handleClickOpenEdit();
            setApprovalEmployeeEdit(res?.data?.sgroup);
        } catch (err) {
            handleApiError(err, setPopupContentMalert, setPopupSeverityMalert, handleClickOpenPopupMalert);
        }
    };
    ...
    let updateby = approvalEmployeeEdit.updatedby;
    let addedby = approvalEmployeeEdit.addedby;
    let projectsid = approvalEmployeeEdit._id;
    ...
    const sendEditRequest = async () => {
        ...
        try {
            let res = await axios.put(`${SERVICE.GROUP_SINGLE}/${projectsid}`, {
                ...
                name: String(approvalEmployeeEdit.name),
                updatedby: [
                    ...updateby,
                    {
                        name: String(isUserRoleAccess.companyname),
            ...
            setApprovalEmployeeEdit(res.data);
    ...
    const fetchAllClient = async () => {
        ...
        try {
            ...
            setApprovalEmployeetwos(res_grp?.data?.groups.map((item, index) => ({
                ...item,
                serialNumber: index + 1,
            })));
            setLoader(true);
    ...
    useEffect(() => {
        addSerialNumbertwo(approvalEmployeetwos);
    }, [approvalEmployeetwos]);
    ...
    const columnDataTabletwo = [
        ...
        },
        {
            ...
            flex: 0,
            width: 100,
            hide: !columnVisibilitytwo.branch,
            headerClassName: "bold-header",
        },
        {
            field: "unit",
        ...
        },
        {
            ...
            flex: 0,
            width: 100,
            hide: !columnVisibilitytwo.notvalid,
            headerClassName: "bold-header",
        },
        {
            field: "validerror",
        ...
        },
        {
            ...
            flex: 0,
            width: 100,
            hide: !columnVisibilitytwo.approved,
            headerClassName: "bold-header",
        },
        {
            field: "reject",
            ...
            flex: 0,
            width: 100,
            hide: !columnVisibilitytwo.reject,
            headerClassName: "bold-header",
        },
        {
            field: "recheck",
    ...
    return (
        <Box>
            ...
            <PageHeading
                title="Approval Employee Forward"
                modulename="Quality"
                submodulename="Penalty"
                mainpagename="Penalty Setup"
                subpagename="Penalty Calculation"
                subsubpagename="Approval Employee Forward"
            />
            {isUserRoleCompare?.includes("aapprovalemployeeforward") && (
                <>
                        ...
                        <>
                            ...
                            <Grid item md={4} xs={12} sm={6}>
                                    ...
                                    <Typography>
                                        ...
                                        <Selects
                                        options={modeoneOpt}
                                            value={{ label: approvalEmployee.modeone, value: approvalEmployee.modeone }}
                                            onChange={((e) => {
                                                setApprovalEmployee({
                                                    ...approvalEmployee,
                                                    modeone: e.value,
                                ...
                                <Grid item md={4} xs={12} sm={6}>
                                    ...
                                    <Typography>
                                        ...
                                        <Selects
                                          options={modetwoOpt}
                                            value={{ label: approvalEmployee.levelmode, value: approvalEmployee.levelmode }}
                                            onChange={((e) => {
                                                setApprovalEmployee({
                                                    ...approvalEmployee,
                                                    levelmode: e.value,
                                ...
                                <Grid item md={4} xs={12} sm={6}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <OutlinedInput
                                            ...
                                            value={approvalEmployee.fromdate}
                                            onChange={(e) => {
                                                setApprovalEmployee({ ...approvalEmployee, fromdate: e.target.value });
                                            }}
                                        />
                                    </FormControl>
                                </Grid>
                                <Grid item md={4} xs={12} sm={6}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        <OutlinedInput
                                            ...
                                            type="date"
                                            placeholder="Please Enter name"
                                            value={approvalEmployee.todate}
                                            onChange={(e) => {
                                                setApprovalEmployee({ ...approvalEmployee, todate: e.target.value });
                                            }}
                                        />
                                    </FormControl>
                                </Grid>
                                ...
                                <Grid container spacing={2}>
                                    <Grid item md={12} xs={12} sm={12}>
                                        <Typography sx={userStyle.HeaderText}>
                                            Edit Approval Employee Forward
                                        </Typography>
                                    </Grid>
                                </Grid>
                                <br />
                                    ...
                                    <Grid item md={12} xs={12} sm={6}>
                                        <FormControl fullWidth size="small">
                                            ...
                                            <OutlinedInput
                                                ...
                                                type="text"
                                                placeholder="Please Enter name"
                                                value={approvalEmployeeEdit.name}
                                                onChange={(e) => {
                                                    setApprovalEmployeeEdit({ ...approvalEmployeeEdit, name: e.target.value });
                                                }}
                                            />
                                        </FormControl>
                                    </Grid>
            ...
            {isUserRoleCompare?.includes("lapprovalemployeeforward") && (
                ...
                <>
                    <Box sx={userStyle.container}>
                        ...
                        <Grid item xs={8}>
                            <Typography sx={userStyle.importheadtext}>
                            {/* Approval Employee Forward List */}
                                Employee Waiver Request List
                            </Typography>
                        </Grid>
                        ...
                        &ensp;
                        {/* {isUserRoleCompare?.includes("bdapprovalemployeeforward") && (
                            <Button
                                variant="contained"
                            ...
                            <Grid item md={2} xs={12} sm={12}>
                                <Box>
                                    ...
                                    >
                                        ...
                                        <MenuItem value={50}>50</MenuItem>
                                        <MenuItem value={100}>100</MenuItem>
                                        <MenuItem value={approvalEmployeetwos?.length}>All</MenuItem>
                                    </Select>
                                </Box>
                            </Grid>
                            <Grid
                            ...
                            <Grid item md={2} xs={6} sm={6}>
                                <Box>
                                    <AggregatedSearchBar
                                        ...
                                        setPage={setPagetwo}
                                        maindatas={approvalEmployeetwos}
            ...
            >
                <Box sx={{ width: "550px", padding: "20px 50px" }}>
                    <>
                        <Typography sx={userStyle.HeaderText}> View Approval Employee Forward</Typography>
                        <br /> <br />
                        <Grid container spacing={2}>
                            <Grid item md={12} xs={12} sm={12}>
                                <FormControl fullWidth size="small">
                                    <Typography variant="h6">Name</Typography>
                                    <Typography>{approvalEmployeeEdit.name}</Typography>
                                </FormControl>
                            </Grid>
                        </Grid>
                        <br /> <br /> <br />
            ...
            <ExportData
                ...
                filename={"Employee Waiver Request"}
            ...
            <ExportData
                ...
                itemsTwo={approvalEmployeetwos ?? []}
                filename={"Recheck Forward List"}
            ...
            <InfoPopup
                ...
                heading="Approval Employee Forward Info"
                addedby={addedby}
                updateby={updateby}
            />

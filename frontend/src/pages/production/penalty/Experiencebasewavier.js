...
function Experiencepercentage() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const isNameMatch = experiencebases.some(item => item.experience.toLowerCase() == (experiencebase.experience).toLowerCase() 
        // && item.percentage.toLowerCase() == (experiencebase.percentage).toLowerCase()
    );
    ...
    const editSubmit = (e) => {
        ...
        const isNameMatch = allExperiencebaseedit.some(item => item.experience.toLowerCase() == (experiencebaseEdit.experience).toLowerCase() 
        // && item.percentage.toLowerCase() == (experiencebaseEdit.percentage).toLowerCase()
    );

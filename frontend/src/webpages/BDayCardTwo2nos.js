...
const BDayCardTwo2nos = () => {
    ...
    const fetchDobs = async () => {
        try {
            ...
            if (employeeOneID) {
                setEmployeeOneDob(await fetchEmployeeDob(employeeOneID));
            }

            if (employeeTwoID) {
                setEmployeeTwoDob(await fetchEmployeeDob(employeeTwoID));
            }
                    ...
                    <div id="twoempprofile">
                        <div id="emponediv">
                            <div id="profileImgtwo2nos" >
                                ...
                                <span className="bdaydobtwo2nos">{employeeOneDob === "" || employeeOneDob === undefined ? "" : moment(employeeOneDob)?.format("DD-MM-YYYY")}</span>
                            </div>
                        ...
                        <div id="emptwodiv">
                            <div id="profileImgtwotwo2nos" >
                                ...
                                <span className="bdaydobtwotwo2nos">{employeeTwoDob === "" || employeeTwoDob === undefined ? "" : moment(employeeTwoDob)?.format("DD-MM-YYYY")}</span>
                            </div>

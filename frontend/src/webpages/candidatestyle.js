...
export const useraccessStyle = {
    ...
    containercontentdisplaytable: {
        ...
        paddingLeft: "80px",
        width: "70vw",
        '& .css-1ygcj2i-MuiTableCell-root': { padding: "5px", backgroundColor: '#f4f6fd' },
        '& .css-1ex1afd-MuiTableCell-root': { padding: "5px", backgroundColor: '#f4f6fd', },

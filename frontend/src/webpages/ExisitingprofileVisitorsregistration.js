                ...
                <Grid sx={{ display: "flex" }}>
                    ...
                    {params?.row?.status === "Candidate" ?
                        ...
                        : params?.row?.status === "Employee" ?
                            ...
                            <>
                                <Link to={`/interactor/master/viewvisitors/${params?.row?.id}/list`} >
                                    <Button
                                        sx={userStyle.buttonedit}
            ...
            <Box>
                ...
                >
                    ...
                    <DialogActions>
                        {selectedRowsCount > 0 ?
                            <>
                                <Button onClick={handleCloseModcheckbox} >Cancel</Button>
                                <Button variant="contained" color='error' 
                                    onClick={(e) => delTaskCatecheckbox(e)}
                                > OK </Button>
                            </>
                            :
                            <Button variant="contained" color='error' onClick={handleCloseModcheckbox} >Ok</Button>
                        }
                    </DialogActions>
                </Dialog>

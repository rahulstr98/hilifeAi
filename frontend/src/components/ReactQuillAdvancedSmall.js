...
const ReactQuillAdvancedSmall = ({ agenda, setAgenda, disabled = false, selectedMargin, setSelectedMargin, pageSize, setPageSize, pageOrientation, setPageOrientation, quillHeight = '100%' }) => {
  ...
  return (
    <>
      <Grid container spacing={1} alignItems="center" sx={{ mb: 2 }}>
        <Grid item>
          <Tooltip title="Undo">
            <Button variant="contained" color="warning" onClick={() => quillRef.current.getEditor().history.undo()} startIcon={<UndoIcon />}>
              Undo
            </Button>
          </Tooltip>
        </Grid>
        ...
        <Grid item>
          <Tooltip title="Redo">
            <Button variant="contained" color="warning" onClick={() => quillRef.current.getEditor().history.redo()} startIcon={<RedoIcon />}>
              Redo
            </Button>
          </Tooltip>
        </Grid>
        ...
        <Grid item>
          <Tooltip title="Copy">
            <Button variant="contained" color="info" onClick={handleCopy} startIcon={<ContentCopyIcon />}>
              Copy
            </Button>
          </Tooltip>
        </Grid>
        ...
        <Grid item>
          <Tooltip title="Cut">
            <Button variant="contained" color="error" onClick={handleCut} startIcon={<ContentCutIcon />}>
              Cut
            </Button>
          </Tooltip>
        </Grid>
        ...
        <Grid item>
          <Tooltip title="Paste">
            <Button variant="contained" color="success" onClick={handlePaste} startIcon={<ContentPasteIcon />}>
              Paste
            </Button>
          </Tooltip>
        </Grid>
        ...
        <Grid item>
          <Tooltip title="Export to PDF">
            <Button variant="contained" color="secondary" onClick={() => handleOpenDialog('pdf')} startIcon={<PictureAsPdfIcon />}>
              PDF
            </Button>
          </Tooltip>
        </Grid>
        ...
        <Grid item>
          <Tooltip title="Export to DOCX">
            <Button variant="contained" color="primary" onClick={() => handleOpenDialog('docx')} startIcon={<DescriptionIcon />}>
              DOCX
            </Button>
          </Tooltip>
        </Grid>
        ...
        <Grid item>
          <Tooltip title="Export to JPG">
            <Button variant="contained" sx={{ bgcolor: '#f57c00', color: '#fff' }} onClick={() => handleOpenDialog('jpg')} startIcon={<ImageIcon />}>
              JPG
            </Button>
          </Tooltip>
        </Grid>
        ...
        <Grid item>
          <Tooltip title="Export to HTML">
            <Button variant="contained" sx={{ bgcolor: '#6d4c41', color: '#fff' }} onClick={() => handleOpenDialog('html')} startIcon={<CodeIcon />}>
              HTML
            </Button>
          </Tooltip>
        </Grid>
        ...
        {/* <Grid item>
          <FormControl size="small" sx={{ minWidth: 150 }}>
            ...
            <Select labelId="margin-label" value={selectedMargin} onChange={handleMarginChange} label="Margin">
        ...
        <Grid item>
          <TextField size="small" label="Search" value={searchTerm} disabled={disabled} onChange={(e) => setSearchTerm(e.target.value)} />
        </Grid>

        <Grid item>
          <TextField size="small" label="Replace" value={replaceTerm} disabled={disabled} onChange={(e) => setReplaceTerm(e.target.value)} />
        </Grid>
        <Grid item>
        ...
        <Grid item>
          <Tooltip title="Print Preview">
            <Button variant="outlined" onClick={handlePrintPreview} startIcon={<PrintIcon />}>
              Preview
            </Button>
          </Tooltip>
        </Grid>
...
export default ReactQuillAdvancedSmall;

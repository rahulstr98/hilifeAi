...
export const accounttypes = [
  ...
  { value: 'THE TIRUCHIRAPALLI DISTRICT CENTRAL CO-OP. BANK LTD', label: 'THE TIRUCHIRAPALLI DISTRICT CENTRAL CO-OP. BANK LTD' },
  {
...
export const sourceVisitorOptions = [
...
export const permanent_address_type = [
  { label: 'Home', value: 'Home' },
  // { label: 'Office', value: 'Office' },
  // { label: 'Hostel', value: 'Hostel' },
];
export const candidate_educational_upload_status = [
...
export const document_size_unit = [
  { label: 'KB', value: 'KB' },
  { label: 'MB', value: 'MB' },
  { label: 'GB', value: 'GB' },
];
export const document_types = [
  ...
  { label: 'Image - JPEG (.jpeg)', value: '.jpeg' },

...
const VisitorinformationmasterSchema = new Schema({
...
VisitorinformationmasterSchema.index({
  date: 1,
  company: 1,
  branch: 1,
  unit: 1,
...
module.exports = mongoose.model('Visitorinformationmaster', VisitorinformationmasterSchema);
